...
// checks if the CreateCodingCIJobByTeamTemplate200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCodingCIJobByTeamTemplate200Response{}

// CreateCodingCIJobByTeamTemplate200Response struct for CreateCodingCIJobByTeamTemplate200Response
type CreateCodingCIJobByTeamTemplate200Response struct {
	Response *CreateCodingCIJobByTeamTemplate200ResponseResponse `json:"Response,omitempty"`
}
...
func NewCreateCodingCIJobByTeamTemplate200Response() *CreateCodingCIJobByTeamTemplate200Response {
	this := CreateCodingCIJobByTeamTemplate200Response{}
	return &this
}
...
func (o *CreateCodingCIJobByTeamTemplate200Response) GetResponse() CreateCodingCIJobByTeamTemplate200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret CreateCodingCIJobByTeamTemplate200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given CreateCodingCIJobByTeamTemplate200ResponseResponse and assigns it to the Response field.
func (o *CreateCodingCIJobByTeamTemplate200Response) SetResponse(v CreateCodingCIJobByTeamTemplate200ResponseResponse) {
	o.Response = &v
}

func (o CreateCodingCIJobByTeamTemplate200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateCodingCIJobByTeamTemplate200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCodingCIJobByTeamTemplate200Response struct {
	value *CreateCodingCIJobByTeamTemplate200Response
	isSet bool
}

func (v NullableCreateCodingCIJobByTeamTemplate200Response) Get() *CreateCodingCIJobByTeamTemplate200Response {
	return v.value
}

func (v *NullableCreateCodingCIJobByTeamTemplate200Response) Set(val *CreateCodingCIJobByTeamTemplate200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCodingCIJobByTeamTemplate200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCodingCIJobByTeamTemplate200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCodingCIJobByTeamTemplate200Response(val *CreateCodingCIJobByTeamTemplate200Response) *NullableCreateCodingCIJobByTeamTemplate200Response {
	return &NullableCreateCodingCIJobByTeamTemplate200Response{value: val, isSet: true}
}

func (v NullableCreateCodingCIJobByTeamTemplate200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCodingCIJobByTeamTemplate200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
