...
var _ MappedNullable = &MergeRequestDiff{}

// MergeRequestDiff 合并请求 diff 信息
type MergeRequestDiff struct {
	// 一共减少行数
	Deletions NullableInt64 `json:"Deletions,omitempty"`
	// 一共新增行数
	Insertions NullableInt64 `json:"Insertions,omitempty"`
	// diff 信息是否过多，不宜于展示
	IsLarge NullableBool `json:"IsLarge,omitempty"`
	// 源分支对应的Sha值
	NewSha NullableString `json:"NewSha,omitempty"`
	// 目标分支对应的Sha值
	OldSha NullableString `json:"OldSha,omitempty"`
	// 文件信息
...
func NewMergeRequestDiff() *MergeRequestDiff {
	...
	this.IsLarge = *NewNullableBool(&isLarge)
	var newSha string = ""
	this.NewSha = *NewNullableString(&newSha)
	var oldSha string = ""
	this.OldSha = *NewNullableString(&oldSha)
	return &this
}
...
func (o *MergeRequestDiff) GetDeletions() int64 {
	if o == nil || IsNil(o.Deletions.Get()) {
		var ret int64
		return ret
	}
...
// SetDeletions gets a reference to the given NullableInt64 and assigns it to the Deletions field.
...
func (o *MergeRequestDiff) GetInsertions() int64 {
	if o == nil || IsNil(o.Insertions.Get()) {
		var ret int64
		return ret
	}
...
// SetInsertions gets a reference to the given NullableInt64 and assigns it to the Insertions field.
...
// SetIsLarge gets a reference to the given NullableBool and assigns it to the IsLarge field.
...
// SetNewSha gets a reference to the given NullableString and assigns it to the NewSha field.
...
// SetOldSha gets a reference to the given NullableString and assigns it to the OldSha field.
