...
// checks if the DescribeIssueFilterList200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeIssueFilterList200ResponseResponse{}

// DescribeIssueFilterList200ResponseResponse 公共返回体
type DescribeIssueFilterList200ResponseResponse struct {
	Data *IssueFilterListData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeIssueFilterList200ResponseResponse() *DescribeIssueFilterList200ResponseResponse {
	this := DescribeIssueFilterList200ResponseResponse{}
...
// SetData gets a reference to the given IssueFilterListData and assigns it to the Data field.
...
func (o DescribeIssueFilterList200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeIssueFilterList200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeIssueFilterList200ResponseResponse struct {
	value *DescribeIssueFilterList200ResponseResponse
	isSet bool
}

func (v NullableDescribeIssueFilterList200ResponseResponse) Get() *DescribeIssueFilterList200ResponseResponse {
	return v.value
}

func (v *NullableDescribeIssueFilterList200ResponseResponse) Set(val *DescribeIssueFilterList200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeIssueFilterList200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeIssueFilterList200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeIssueFilterList200ResponseResponse(val *DescribeIssueFilterList200ResponseResponse) *NullableDescribeIssueFilterList200ResponseResponse {
	return &NullableDescribeIssueFilterList200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeIssueFilterList200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeIssueFilterList200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
