...
type Contributor struct {
	// 提交次数
	Commits NullableInt64 `json:"Commits,omitempty"`
	// 邮箱
...
// SetCommits gets a reference to the given NullableInt64 and assigns it to the Commits field.
