...
// checks if the DepotDetailData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DepotDetailData{}

// DepotDetailData 仓库提交详情
type DepotDetailData struct {
	// 仓库信息列表
	DepotDetailList []CodingCIDepotDetail `json:"DepotDetailList,omitempty"`
}
...
// GetDepotDetailList returns the DepotDetailList field value if set, zero value otherwise.
func (o *DepotDetailData) GetDepotDetailList() []CodingCIDepotDetail {
	if o == nil || IsNil(o.DepotDetailList) {
		var ret []CodingCIDepotDetail
		return ret
	}
	return o.DepotDetailList
}

// GetDepotDetailListOk returns a tuple with the DepotDetailList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DepotDetailData) GetDepotDetailListOk() ([]CodingCIDepotDetail, bool) {
	if o == nil || IsNil(o.DepotDetailList) {
		return nil, false
	}
	return o.DepotDetailList, true
}
...
// SetDepotDetailList gets a reference to the given []CodingCIDepotDetail and assigns it to the DepotDetailList field.
func (o *DepotDetailData) SetDepotDetailList(v []CodingCIDepotDetail) {
	o.DepotDetailList = v
}

func (o DepotDetailData) MarshalJSON() ([]byte, error) {
...
func (o DepotDetailData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DepotDetailList) {
		toSerialize["DepotDetailList"] = o.DepotDetailList
	}
	return toSerialize, nil
}

type NullableDepotDetailData struct {
	value *DepotDetailData
	isSet bool
}

func (v NullableDepotDetailData) Get() *DepotDetailData {
	return v.value
}

func (v *NullableDepotDetailData) Set(val *DepotDetailData) {
	v.value = val
	v.isSet = true
}

func (v NullableDepotDetailData) IsSet() bool {
	return v.isSet
}

func (v *NullableDepotDetailData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDepotDetailData(val *DepotDetailData) *NullableDepotDetailData {
	return &NullableDepotDetailData{value: val, isSet: true}
}

func (v NullableDepotDetailData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDepotDetailData) UnmarshalJSON(src []byte) error {
	v.isSet = true
