...
// checks if the DescribeSubIssueList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeSubIssueList200Response{}

// DescribeSubIssueList200Response struct for DescribeSubIssueList200Response
type DescribeSubIssueList200Response struct {
	Response *DescribeSubIssueList200ResponseResponse `json:"Response,omitempty"`
}
...
func NewDescribeSubIssueList200Response() *DescribeSubIssueList200Response {
	this := DescribeSubIssueList200Response{}
	return &this
}
...
func (o *DescribeSubIssueList200Response) GetResponse() DescribeSubIssueList200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret DescribeSubIssueList200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given DescribeSubIssueList200ResponseResponse and assigns it to the Response field.
func (o *DescribeSubIssueList200Response) SetResponse(v DescribeSubIssueList200ResponseResponse) {
	o.Response = &v
}

func (o DescribeSubIssueList200Response) MarshalJSON() ([]byte, error) {
...
func (o DescribeSubIssueList200Response) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeSubIssueList200Response struct {
	value *DescribeSubIssueList200Response
	isSet bool
}

func (v NullableDescribeSubIssueList200Response) Get() *DescribeSubIssueList200Response {
	return v.value
}

func (v *NullableDescribeSubIssueList200Response) Set(val *DescribeSubIssueList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeSubIssueList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeSubIssueList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeSubIssueList200Response(val *DescribeSubIssueList200Response) *NullableDescribeSubIssueList200Response {
	return &NullableDescribeSubIssueList200Response{value: val, isSet: true}
}

func (v NullableDescribeSubIssueList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeSubIssueList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
