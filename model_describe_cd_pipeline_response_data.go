...
var _ MappedNullable = &DescribeCdPipelineResponseData{}
...
func (o *DescribeCdPipelineResponseData) GetPipelineConfigId() string {
	if o == nil || IsNil(o.PipelineConfigId) {
		var ret string
		return ret
	}
...
func (o *DescribeCdPipelineResponseData) GetPipelineExecutionJsonContent() string {
	if o == nil || IsNil(o.PipelineExecutionJsonContent) {
		var ret string
		return ret
	}
...
func (o *DescribeCdPipelineResponseData) GetPipelineExecutionStatus() string {
	if o == nil || IsNil(o.PipelineExecutionStatus) {
		var ret string
		return ret
	}
