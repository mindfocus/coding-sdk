...
// checks if the DescribeBranchProtectionsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeBranchProtectionsRequest{}

// DescribeBranchProtectionsRequest struct for DescribeBranchProtectionsRequest
type DescribeBranchProtectionsRequest struct {
	// 仓库id
...
type _DescribeBranchProtectionsRequest DescribeBranchProtectionsRequest
...
func NewDescribeBranchProtectionsRequest(depotId int64) *DescribeBranchProtectionsRequest {
	this := DescribeBranchProtectionsRequest{}
...
func (o DescribeBranchProtectionsRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeBranchProtectionsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeBranchProtectionsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeBranchProtectionsRequest := _DescribeBranchProtectionsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeBranchProtectionsRequest)

	if err != nil {
		return err
	}

	*o = DescribeBranchProtectionsRequest(varDescribeBranchProtectionsRequest)

	return err
}

type NullableDescribeBranchProtectionsRequest struct {
	value *DescribeBranchProtectionsRequest
	isSet bool
}

func (v NullableDescribeBranchProtectionsRequest) Get() *DescribeBranchProtectionsRequest {
	return v.value
}

func (v *NullableDescribeBranchProtectionsRequest) Set(val *DescribeBranchProtectionsRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeBranchProtectionsRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeBranchProtectionsRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeBranchProtectionsRequest(val *DescribeBranchProtectionsRequest) *NullableDescribeBranchProtectionsRequest {
	return &NullableDescribeBranchProtectionsRequest{value: val, isSet: true}
}

func (v NullableDescribeBranchProtectionsRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeBranchProtectionsRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
