...
type Mission struct {
	...
	// 目标项目名称
	TargetProjectName NullableString `json:"TargetProjectName,omitempty"`
	// 类型
...
func NewMission() *Mission {
	this := Mission{}
	var link string = ""
	this.Link = *NewNullableString(&link)
	var targetProjectName string = ""
	this.TargetProjectName = *NewNullableString(&targetProjectName)
...
func (o *Mission) GetTargetProjectName() string {
	if o == nil || IsNil(o.TargetProjectName.Get()) {
		var ret string
		return ret
	}
...
// SetTargetProjectName gets a reference to the given NullableString and assigns it to the TargetProjectName field.
