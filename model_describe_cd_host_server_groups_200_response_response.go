...
// checks if the DescribeCdHostServerGroups200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCdHostServerGroups200ResponseResponse{}

// DescribeCdHostServerGroups200ResponseResponse 公共返回体
type DescribeCdHostServerGroups200ResponseResponse struct {
	Data *DescribeCdHostServerGroupsResponseData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeCdHostServerGroups200ResponseResponse() *DescribeCdHostServerGroups200ResponseResponse {
	this := DescribeCdHostServerGroups200ResponseResponse{}
...
func (o *DescribeCdHostServerGroups200ResponseResponse) GetData() DescribeCdHostServerGroupsResponseData {
	if o == nil || IsNil(o.Data) {
		var ret DescribeCdHostServerGroupsResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DescribeCdHostServerGroupsResponseData and assigns it to the Data field.
...
func (o DescribeCdHostServerGroups200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeCdHostServerGroups200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCdHostServerGroups200ResponseResponse struct {
	value *DescribeCdHostServerGroups200ResponseResponse
	isSet bool
}

func (v NullableDescribeCdHostServerGroups200ResponseResponse) Get() *DescribeCdHostServerGroups200ResponseResponse {
	return v.value
}

func (v *NullableDescribeCdHostServerGroups200ResponseResponse) Set(val *DescribeCdHostServerGroups200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCdHostServerGroups200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCdHostServerGroups200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCdHostServerGroups200ResponseResponse(val *DescribeCdHostServerGroups200ResponseResponse) *NullableDescribeCdHostServerGroups200ResponseResponse {
	return &NullableDescribeCdHostServerGroups200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeCdHostServerGroups200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCdHostServerGroups200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
