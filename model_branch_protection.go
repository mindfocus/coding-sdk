...
func (o *BranchProtection) GetAutoAddReviewer() bool {
	if o == nil || IsNil(o.AutoAddReviewer) {
		var ret bool
		return ret
	}
...
func (o *BranchProtection) GetBranchProtectionId() int64 {
	if o == nil || IsNil(o.BranchProtectionId) {
		var ret int64
		return ret
	}
...
func (o *BranchProtection) GetDenyForcePush() bool {
	if o == nil || IsNil(o.DenyForcePush) {
		var ret bool
		return ret
	}
...
func (o *BranchProtection) GetRequiredCodeOwnerGrant() bool {
	if o == nil || IsNil(o.RequiredCodeOwnerGrant) {
		var ret bool
		return ret
	}
...
func (o *BranchProtection) GetRequiredDiscussionResolved() bool {
	if o == nil || IsNil(o.RequiredDiscussionResolved) {
		var ret bool
		return ret
	}
...
func (o *BranchProtection) GetRequiredGrantCount() int64 {
	if o == nil || IsNil(o.RequiredGrantCount) {
		var ret int64
		return ret
	}
...
func (o *BranchProtection) GetRequiredStatusCheck() bool {
	if o == nil || IsNil(o.RequiredStatusCheck) {
		var ret bool
		return ret
	}
...
func (o *BranchProtection) GetSrcMustMergedTo() string {
	if o == nil || IsNil(o.SrcMustMergedTo) {
		var ret string
		return ret
	}
