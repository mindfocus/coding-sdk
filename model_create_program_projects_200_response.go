...
// checks if the CreateProgramProjects200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateProgramProjects200Response{}

// CreateProgramProjects200Response struct for CreateProgramProjects200Response
type CreateProgramProjects200Response struct {
	Response *CreateProgramProjects200ResponseResponse `json:"Response,omitempty"`
}
...
func NewCreateProgramProjects200Response() *CreateProgramProjects200Response {
	this := CreateProgramProjects200Response{}
	return &this
}
...
func (o *CreateProgramProjects200Response) GetResponse() CreateProgramProjects200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret CreateProgramProjects200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given CreateProgramProjects200ResponseResponse and assigns it to the Response field.
func (o *CreateProgramProjects200Response) SetResponse(v CreateProgramProjects200ResponseResponse) {
	o.Response = &v
}

func (o CreateProgramProjects200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateProgramProjects200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateProgramProjects200Response struct {
	value *CreateProgramProjects200Response
	isSet bool
}

func (v NullableCreateProgramProjects200Response) Get() *CreateProgramProjects200Response {
	return v.value
}

func (v *NullableCreateProgramProjects200Response) Set(val *CreateProgramProjects200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateProgramProjects200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateProgramProjects200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateProgramProjects200Response(val *CreateProgramProjects200Response) *NullableCreateProgramProjects200Response {
	return &NullableCreateProgramProjects200Response{value: val, isSet: true}
}

func (v NullableCreateProgramProjects200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateProgramProjects200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
