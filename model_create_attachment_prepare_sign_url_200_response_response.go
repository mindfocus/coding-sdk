...
// checks if the CreateAttachmentPrepareSignUrl200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAttachmentPrepareSignUrl200ResponseResponse{}

// CreateAttachmentPrepareSignUrl200ResponseResponse 公共返回体
type CreateAttachmentPrepareSignUrl200ResponseResponse struct {
	Data *AttachmentPrepareData `json:"Data,omitempty"`
	// 请求id
...
func NewCreateAttachmentPrepareSignUrl200ResponseResponse() *CreateAttachmentPrepareSignUrl200ResponseResponse {
	this := CreateAttachmentPrepareSignUrl200ResponseResponse{}
...
// SetData gets a reference to the given AttachmentPrepareData and assigns it to the Data field.
...
func (o CreateAttachmentPrepareSignUrl200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateAttachmentPrepareSignUrl200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAttachmentPrepareSignUrl200ResponseResponse struct {
	value *CreateAttachmentPrepareSignUrl200ResponseResponse
	isSet bool
}

func (v NullableCreateAttachmentPrepareSignUrl200ResponseResponse) Get() *CreateAttachmentPrepareSignUrl200ResponseResponse {
	return v.value
}

func (v *NullableCreateAttachmentPrepareSignUrl200ResponseResponse) Set(val *CreateAttachmentPrepareSignUrl200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAttachmentPrepareSignUrl200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAttachmentPrepareSignUrl200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAttachmentPrepareSignUrl200ResponseResponse(val *CreateAttachmentPrepareSignUrl200ResponseResponse) *NullableCreateAttachmentPrepareSignUrl200ResponseResponse {
	return &NullableCreateAttachmentPrepareSignUrl200ResponseResponse{value: val, isSet: true}
}

func (v NullableCreateAttachmentPrepareSignUrl200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAttachmentPrepareSignUrl200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
