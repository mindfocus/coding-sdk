...
var _ MappedNullable = &GrepLineInfo{}

// GrepLineInfo 代码片段搜索信息详细列表
type GrepLineInfo struct {
	// 分支名称
	BranchName NullableString `json:"BranchName,omitempty"`
	// 提交Id
	CommitId NullableString `json:"CommitId,omitempty"`
	// 文件内容
	Contents []string `json:"Contents,omitempty"`
	// 文件最大行数
	FileMaxLine NullableInt64 `json:"FileMaxLine,omitempty"`
	// 代码片段的行数
	LineNum NullableInt64 `json:"LineNum,omitempty"`
	// 页面上展现的最大行数
	MaxNum NullableInt64 `json:"MaxNum,omitempty"`
	// 页面上展现的最小行数
	MinNum NullableInt64 `json:"MinNum,omitempty"`
	// 代码片段对应的文件路径
...
func NewGrepLineInfo() *GrepLineInfo {
	...
	this.BranchName = *NewNullableString(&branchName)
	var commitId string = ""
	this.CommitId = *NewNullableString(&commitId)
	var path string = ""
	this.Path = *NewNullableString(&path)
	var text string = ""
	this.Text = *NewNullableString(&text)
	return &this
}
...
func (o *GrepLineInfo) GetFileMaxLine() int64 {
	if o == nil || IsNil(o.FileMaxLine.Get()) {
		var ret int64
		return ret
	}
...
// SetFileMaxLine gets a reference to the given NullableInt64 and assigns it to the FileMaxLine field.
...
// SetLineNum gets a reference to the given NullableInt64 and assigns it to the LineNum field.
...
// SetMaxNum gets a reference to the given NullableInt64 and assigns it to the MaxNum field.
...
// SetMinNum gets a reference to the given NullableInt64 and assigns it to the MinNum field.
