...
// checks if the CreateGitProtectedTagRulesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGitProtectedTagRulesRequest{}

// CreateGitProtectedTagRulesRequest struct for CreateGitProtectedTagRulesRequest
type CreateGitProtectedTagRulesRequest struct {
	// 仓库 Id
...
type _CreateGitProtectedTagRulesRequest CreateGitProtectedTagRulesRequest
...
func NewCreateGitProtectedTagRulesRequest(depotId int64, rule []string) *CreateGitProtectedTagRulesRequest {
	this := CreateGitProtectedTagRulesRequest{}
...
func (o CreateGitProtectedTagRulesRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateGitProtectedTagRulesRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGitProtectedTagRulesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGitProtectedTagRulesRequest := _CreateGitProtectedTagRulesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGitProtectedTagRulesRequest)

	if err != nil {
		return err
	}

	*o = CreateGitProtectedTagRulesRequest(varCreateGitProtectedTagRulesRequest)

	return err
}

type NullableCreateGitProtectedTagRulesRequest struct {
	value *CreateGitProtectedTagRulesRequest
	isSet bool
}

func (v NullableCreateGitProtectedTagRulesRequest) Get() *CreateGitProtectedTagRulesRequest {
	return v.value
}

func (v *NullableCreateGitProtectedTagRulesRequest) Set(val *CreateGitProtectedTagRulesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGitProtectedTagRulesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGitProtectedTagRulesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGitProtectedTagRulesRequest(val *CreateGitProtectedTagRulesRequest) *NullableCreateGitProtectedTagRulesRequest {
	return &NullableCreateGitProtectedTagRulesRequest{value: val, isSet: true}
}

func (v NullableCreateGitProtectedTagRulesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGitProtectedTagRulesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
