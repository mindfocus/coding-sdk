...
var _ MappedNullable = &ModifyGitTransfer200ResponseResponse{}

// ModifyGitTransfer200ResponseResponse 公共返回体
type ModifyGitTransfer200ResponseResponse struct {
	// 转移后 web 页面的访问路径(不包含域名)
	NewDepotPath NullableString `json:"NewDepotPath,omitempty"`
	// 请求id
...
func (o *ModifyGitTransfer200ResponseResponse) GetNewDepotPath() string {
	if o == nil || IsNil(o.NewDepotPath.Get()) {
		var ret string
		return ret
	}
...
// SetNewDepotPath gets a reference to the given NullableString and assigns it to the NewDepotPath field.
