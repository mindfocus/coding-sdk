...
func (o GitRef) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RefObjectId) {
		toSerialize["RefObjectId"] = o.RefObjectId
	}
	if !IsNil(o.ShortMessage) {
