...
// checks if the DescribeArtifactVersionList200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeArtifactVersionList200ResponseResponse{}

// DescribeArtifactVersionList200ResponseResponse 公共返回体
type DescribeArtifactVersionList200ResponseResponse struct {
	Data *ArtifactVersionPageBean `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeArtifactVersionList200ResponseResponse() *DescribeArtifactVersionList200ResponseResponse {
	this := DescribeArtifactVersionList200ResponseResponse{}
...
func (o *DescribeArtifactVersionList200ResponseResponse) GetData() ArtifactVersionPageBean {
	if o == nil || IsNil(o.Data) {
		var ret ArtifactVersionPageBean
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ArtifactVersionPageBean and assigns it to the Data field.
...
func (o DescribeArtifactVersionList200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeArtifactVersionList200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeArtifactVersionList200ResponseResponse struct {
	value *DescribeArtifactVersionList200ResponseResponse
	isSet bool
}

func (v NullableDescribeArtifactVersionList200ResponseResponse) Get() *DescribeArtifactVersionList200ResponseResponse {
	return v.value
}

func (v *NullableDescribeArtifactVersionList200ResponseResponse) Set(val *DescribeArtifactVersionList200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeArtifactVersionList200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeArtifactVersionList200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeArtifactVersionList200ResponseResponse(val *DescribeArtifactVersionList200ResponseResponse) *NullableDescribeArtifactVersionList200ResponseResponse {
	return &NullableDescribeArtifactVersionList200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeArtifactVersionList200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeArtifactVersionList200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
