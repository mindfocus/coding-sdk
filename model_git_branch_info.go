...
var _ MappedNullable = &GitBranchInfo{}
...
type GitBranchInfo struct {
	...
	// 是否可以ForceSquash
	ForceSquash NullableBool `json:"ForceSquash,omitempty"`
	// 是否默认分支
	...
	// 最后提交时间
	LastCommitDate NullableInt64 `json:"LastCommitDate,omitempty"`
	// 分支sha值
	Sha *string `json:"Sha,omitempty"`
	// 仓库规范类型
	SpecBranchType NullableString `json:"SpecBranchType,omitempty"`
}
...
func NewGitBranchInfo() *GitBranchInfo {
	...
	this.ForceSquash = *NewNullableBool(&forceSquash)
	var isDefaultBranch bool = false
	this.IsDefaultBranch = &isDefaultBranch
	var isProtected bool = false
	this.IsProtected = &isProtected
	var isReadOnly bool = false
	this.IsReadOnly = *NewNullableBool(&isReadOnly)
	var sha string = ""
	this.Sha = &sha
	var specBranchType string = ""
	this.SpecBranchType = *NewNullableString(&specBranchType)
	return &this
}
...
func (o *GitBranchInfo) GetForceSquash() bool {
	if o == nil || IsNil(o.ForceSquash.Get()) {
		var ret bool
		return ret
	}
...
// SetForceSquash gets a reference to the given NullableBool and assigns it to the ForceSquash field.
...
func (o *GitBranchInfo) GetIsDefaultBranch() bool {
	if o == nil || IsNil(o.IsDefaultBranch) {
		var ret bool
		return ret
	}
...
func (o *GitBranchInfo) GetLastCommitDate() int64 {
	if o == nil || IsNil(o.LastCommitDate.Get()) {
		var ret int64
		return ret
	}
...
// SetLastCommitDate gets a reference to the given NullableInt64 and assigns it to the LastCommitDate field.
...
func (o *GitBranchInfo) GetSpecBranchType() string {
	if o == nil || IsNil(o.SpecBranchType.Get()) {
		var ret string
		return ret
	}
...
// SetSpecBranchType gets a reference to the given NullableString and assigns it to the SpecBranchType field.
