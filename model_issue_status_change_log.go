...
var _ MappedNullable = &IssueStatusChangeLog{}
...
type IssueStatusChangeLog struct {
	...
	// 事项code
	IssueCode NullableInt64 `json:"IssueCode,omitempty"`
...
func NewIssueStatusChangeLog() *IssueStatusChangeLog {
	...
	this.StatusName = *NewNullableString(&statusName)
	return &this
}
...
func (o *IssueStatusChangeLog) GetIssueCode() int64 {
	if o == nil || IsNil(o.IssueCode.Get()) {
		var ret int64
		return ret
	}
...
// SetIssueCode gets a reference to the given NullableInt64 and assigns it to the IssueCode field.
