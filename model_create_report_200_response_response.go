...
// checks if the CreateReport200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateReport200ResponseResponse{}

// CreateReport200ResponseResponse 公共返回体
type CreateReport200ResponseResponse struct {
	Data *ReportLittleData `json:"Data,omitempty"`
	// 请求id
...
func NewCreateReport200ResponseResponse() *CreateReport200ResponseResponse {
	this := CreateReport200ResponseResponse{}
...
// SetData gets a reference to the given ReportLittleData and assigns it to the Data field.
...
func (o CreateReport200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateReport200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateReport200ResponseResponse struct {
	value *CreateReport200ResponseResponse
	isSet bool
}

func (v NullableCreateReport200ResponseResponse) Get() *CreateReport200ResponseResponse {
	return v.value
}

func (v *NullableCreateReport200ResponseResponse) Set(val *CreateReport200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateReport200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateReport200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateReport200ResponseResponse(val *CreateReport200ResponseResponse) *NullableCreateReport200ResponseResponse {
	return &NullableCreateReport200ResponseResponse{value: val, isSet: true}
}

func (v NullableCreateReport200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateReport200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
