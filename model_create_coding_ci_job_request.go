...
var _ MappedNullable = &CreateCodingCIJobRequest{}
...
func (o *CreateCodingCIJobRequest) GetAlwaysUserIdList() []int32 {
	if o == nil || IsNil(o.AlwaysUserIdList) {
		var ret []int32
		return ret
	}
...
func (o *CreateCodingCIJobRequest) GetBranchSelector() string {
	if o == nil || IsNil(o.BranchSelector) {
		var ret string
		return ret
	}
...
func (o *CreateCodingCIJobRequest) GetBuildFailUserIdList() []int32 {
	if o == nil || IsNil(o.BuildFailUserIdList) {
		var ret []int32
		return ret
	}
...
func (o *CreateCodingCIJobRequest) GetCachePathList() []CodingCIJobCachePath {
	if o == nil || IsNil(o.CachePathList) {
...
func (o *CreateCodingCIJobRequest) GetJenkinsFileStaticContent() string {
	if o == nil || IsNil(o.JenkinsFileStaticContent) {
		var ret string
		return ret
	}
...
func (o *CreateCodingCIJobRequest) GetTriggerMethodList() []string {
	if o == nil || IsNil(o.TriggerMethodList) {
		var ret []string
		return ret
	}
...
func (o *CreateCodingCIJobRequest) GetTriggerRemind() string {
	if o == nil || IsNil(o.TriggerRemind) {
		var ret string
		return ret
	}
...
func (o CreateCodingCIJobRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.JenkinsFileStaticContent) {
	...
	if !IsNil(o.TriggerMethodList) {
		toSerialize["TriggerMethodList"] = o.TriggerMethodList
	}
	if !IsNil(o.TriggerRemind) {
