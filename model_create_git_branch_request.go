...
// checks if the CreateGitBranchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGitBranchRequest{}

// CreateGitBranchRequest struct for CreateGitBranchRequest
type CreateGitBranchRequest struct {
	// 分支名称
...
type _CreateGitBranchRequest CreateGitBranchRequest
...
func (o CreateGitBranchRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateGitBranchRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGitBranchRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateGitBranchRequest := _CreateGitBranchRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateGitBranchRequest)

	if err != nil {
		return err
	}

	*o = CreateGitBranchRequest(varCreateGitBranchRequest)

	return err
}

type NullableCreateGitBranchRequest struct {
	value *CreateGitBranchRequest
	isSet bool
}

func (v NullableCreateGitBranchRequest) Get() *CreateGitBranchRequest {
	return v.value
}

func (v *NullableCreateGitBranchRequest) Set(val *CreateGitBranchRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGitBranchRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGitBranchRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGitBranchRequest(val *CreateGitBranchRequest) *NullableCreateGitBranchRequest {
	return &NullableCreateGitBranchRequest{value: val, isSet: true}
}

func (v NullableCreateGitBranchRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGitBranchRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
