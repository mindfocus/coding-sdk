...
// checks if the DescribeGitTagsByShaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitTagsByShaRequest{}

// DescribeGitTagsByShaRequest struct for DescribeGitTagsByShaRequest
type DescribeGitTagsByShaRequest struct {
	// 仓库id
...
type _DescribeGitTagsByShaRequest DescribeGitTagsByShaRequest
...
func NewDescribeGitTagsByShaRequest(depotId int64, sha string) *DescribeGitTagsByShaRequest {
	this := DescribeGitTagsByShaRequest{}
...
func (o DescribeGitTagsByShaRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitTagsByShaRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeGitTagsByShaRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeGitTagsByShaRequest := _DescribeGitTagsByShaRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeGitTagsByShaRequest)

	if err != nil {
		return err
	}

	*o = DescribeGitTagsByShaRequest(varDescribeGitTagsByShaRequest)

	return err
}

type NullableDescribeGitTagsByShaRequest struct {
	value *DescribeGitTagsByShaRequest
	isSet bool
}

func (v NullableDescribeGitTagsByShaRequest) Get() *DescribeGitTagsByShaRequest {
	return v.value
}

func (v *NullableDescribeGitTagsByShaRequest) Set(val *DescribeGitTagsByShaRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitTagsByShaRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitTagsByShaRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitTagsByShaRequest(val *DescribeGitTagsByShaRequest) *NullableDescribeGitTagsByShaRequest {
	return &NullableDescribeGitTagsByShaRequest{value: val, isSet: true}
}

func (v NullableDescribeGitTagsByShaRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitTagsByShaRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
