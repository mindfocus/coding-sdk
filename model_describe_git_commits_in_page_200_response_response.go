...
// checks if the DescribeGitCommitsInPage200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitCommitsInPage200ResponseResponse{}

// DescribeGitCommitsInPage200ResponseResponse 公共返回体
type DescribeGitCommitsInPage200ResponseResponse struct {
...
func NewDescribeGitCommitsInPage200ResponseResponse() *DescribeGitCommitsInPage200ResponseResponse {
	this := DescribeGitCommitsInPage200ResponseResponse{}
...
// SetData gets a reference to the given CommitData and assigns it to the Data field.
...
func (o DescribeGitCommitsInPage200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitCommitsInPage200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeGitCommitsInPage200ResponseResponse struct {
	value *DescribeGitCommitsInPage200ResponseResponse
	isSet bool
}

func (v NullableDescribeGitCommitsInPage200ResponseResponse) Get() *DescribeGitCommitsInPage200ResponseResponse {
	return v.value
}

func (v *NullableDescribeGitCommitsInPage200ResponseResponse) Set(val *DescribeGitCommitsInPage200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitCommitsInPage200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitCommitsInPage200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitCommitsInPage200ResponseResponse(val *DescribeGitCommitsInPage200ResponseResponse) *NullableDescribeGitCommitsInPage200ResponseResponse {
	return &NullableDescribeGitCommitsInPage200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeGitCommitsInPage200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitCommitsInPage200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
