...
// checks if the DescribeCdDeployTrendByProjectResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCdDeployTrendByProjectResponseData{}

// DescribeCdDeployTrendByProjectResponseData DescribeCdDeployTrendByProjectResponseData 结构
type DescribeCdDeployTrendByProjectResponseData struct {
	// 各应用发布趋势详情
...
func NewDescribeCdDeployTrendByProjectResponseData() *DescribeCdDeployTrendByProjectResponseData {
	this := DescribeCdDeployTrendByProjectResponseData{}
	var endDate string = ""
...
func (o DescribeCdDeployTrendByProjectResponseData) MarshalJSON() ([]byte, error) {
...
func (o DescribeCdDeployTrendByProjectResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCdDeployTrendByProjectResponseData struct {
	value *DescribeCdDeployTrendByProjectResponseData
	isSet bool
}

func (v NullableDescribeCdDeployTrendByProjectResponseData) Get() *DescribeCdDeployTrendByProjectResponseData {
	return v.value
}

func (v *NullableDescribeCdDeployTrendByProjectResponseData) Set(val *DescribeCdDeployTrendByProjectResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCdDeployTrendByProjectResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCdDeployTrendByProjectResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCdDeployTrendByProjectResponseData(val *DescribeCdDeployTrendByProjectResponseData) *NullableDescribeCdDeployTrendByProjectResponseData {
	return &NullableDescribeCdDeployTrendByProjectResponseData{value: val, isSet: true}
}

func (v NullableDescribeCdDeployTrendByProjectResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCdDeployTrendByProjectResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
