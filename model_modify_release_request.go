...
var _ MappedNullable = &ModifyReleaseRequest{}
...
func (o *ModifyReleaseRequest) GetDelIterationCodes() []int64 {
	if o == nil || IsNil(o.DelIterationCodes) {
		var ret []int64
		return ret
	}
...
func (o *ModifyReleaseRequest) GetIterationCodes() []int64 {
	if o == nil || IsNil(o.IterationCodes) {
		var ret []int64
		return ret
	}
