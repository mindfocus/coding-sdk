...
var _ MappedNullable = &OpenApiRelease{}
...
type OpenApiRelease struct {
	...
	// 事项完成率 
	CompletedPercent NullableFloat32 `json:"CompletedPercent,omitempty"`
	// 创建时间
...
func (o *OpenApiRelease) GetCompletedPercent() float32 {
	if o == nil || IsNil(o.CompletedPercent.Get()) {
		var ret float32
		return ret
	}
...
// SetCompletedPercent gets a reference to the given NullableFloat32 and assigns it to the CompletedPercent field.
