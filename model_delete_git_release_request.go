...
// checks if the DeleteGitReleaseRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteGitReleaseRequest{}

// DeleteGitReleaseRequest struct for DeleteGitReleaseRequest
type DeleteGitReleaseRequest struct {
	// 仓库id
...
type _DeleteGitReleaseRequest DeleteGitReleaseRequest
...
func (o DeleteGitReleaseRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteGitReleaseRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteGitReleaseRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteGitReleaseRequest := _DeleteGitReleaseRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteGitReleaseRequest)

	if err != nil {
		return err
	}

	*o = DeleteGitReleaseRequest(varDeleteGitReleaseRequest)

	return err
}

type NullableDeleteGitReleaseRequest struct {
	value *DeleteGitReleaseRequest
	isSet bool
}

func (v NullableDeleteGitReleaseRequest) Get() *DeleteGitReleaseRequest {
	return v.value
}

func (v *NullableDeleteGitReleaseRequest) Set(val *DeleteGitReleaseRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteGitReleaseRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteGitReleaseRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteGitReleaseRequest(val *DeleteGitReleaseRequest) *NullableDeleteGitReleaseRequest {
	return &NullableDeleteGitReleaseRequest{value: val, isSet: true}
}

func (v NullableDeleteGitReleaseRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteGitReleaseRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
