...
// checks if the CreateSshKey200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSshKey200Response{}

// CreateSshKey200Response struct for CreateSshKey200Response
type CreateSshKey200Response struct {
...
func (o CreateSshKey200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateSshKey200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSshKey200Response struct {
	value *CreateSshKey200Response
	isSet bool
}

func (v NullableCreateSshKey200Response) Get() *CreateSshKey200Response {
	return v.value
}

func (v *NullableCreateSshKey200Response) Set(val *CreateSshKey200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSshKey200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSshKey200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSshKey200Response(val *CreateSshKey200Response) *NullableCreateSshKey200Response {
	return &NullableCreateSshKey200Response{value: val, isSet: true}
}

func (v NullableCreateSshKey200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSshKey200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
