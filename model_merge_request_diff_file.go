...
var _ MappedNullable = &MergeRequestDiffFile{}

// MergeRequestDiffFile diff 信息详情
type MergeRequestDiffFile struct {
	// 文件对应的 blob Id
	BlobSha NullableString `json:"BlobSha,omitempty"`
	// 文件改变类型
	ChangeType NullableString `json:"ChangeType,omitempty"`
	// 一共删除几行
...
func NewMergeRequestDiffFile() *MergeRequestDiffFile {
	...
	var blobSha string = ""
	this.BlobSha = *NewNullableString(&blobSha)
	var changeType string = ""
	this.ChangeType = *NewNullableString(&changeType)
	var path string = ""
...
// SetBlobSha gets a reference to the given NullableString and assigns it to the BlobSha field.
...
func (o *MergeRequestDiffFile) GetChangeType() string {
	if o == nil || IsNil(o.ChangeType.Get()) {
		var ret string
		return ret
	}
...
// SetChangeType gets a reference to the given NullableString and assigns it to the ChangeType field.
