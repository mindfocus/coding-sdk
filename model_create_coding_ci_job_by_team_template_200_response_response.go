...
// checks if the CreateCodingCIJobByTeamTemplate200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCodingCIJobByTeamTemplate200ResponseResponse{}

// CreateCodingCIJobByTeamTemplate200ResponseResponse 公共返回体
type CreateCodingCIJobByTeamTemplate200ResponseResponse struct {
	Data *JobCreateJobData `json:"Data,omitempty"`
	// 请求id
...
func NewCreateCodingCIJobByTeamTemplate200ResponseResponse() *CreateCodingCIJobByTeamTemplate200ResponseResponse {
	this := CreateCodingCIJobByTeamTemplate200ResponseResponse{}
...
// SetData gets a reference to the given JobCreateJobData and assigns it to the Data field.
...
func (o CreateCodingCIJobByTeamTemplate200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateCodingCIJobByTeamTemplate200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCodingCIJobByTeamTemplate200ResponseResponse struct {
	value *CreateCodingCIJobByTeamTemplate200ResponseResponse
	isSet bool
}

func (v NullableCreateCodingCIJobByTeamTemplate200ResponseResponse) Get() *CreateCodingCIJobByTeamTemplate200ResponseResponse {
	return v.value
}

func (v *NullableCreateCodingCIJobByTeamTemplate200ResponseResponse) Set(val *CreateCodingCIJobByTeamTemplate200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCodingCIJobByTeamTemplate200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCodingCIJobByTeamTemplate200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCodingCIJobByTeamTemplate200ResponseResponse(val *CreateCodingCIJobByTeamTemplate200ResponseResponse) *NullableCreateCodingCIJobByTeamTemplate200ResponseResponse {
	return &NullableCreateCodingCIJobByTeamTemplate200ResponseResponse{value: val, isSet: true}
}

func (v NullableCreateCodingCIJobByTeamTemplate200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCodingCIJobByTeamTemplate200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
