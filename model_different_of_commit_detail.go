...
var _ MappedNullable = &DifferentOfCommitDetail{}
...
func (o *DifferentOfCommitDetail) GetDifferentOfCommits() []DifferentOfCommit {
	if o == nil || IsNil(o.DifferentOfCommits) {
...
func (o *DifferentOfCommitDetail) GetUpdateFileNum() int64 {
	if o == nil || IsNil(o.UpdateFileNum) {
		var ret int64
		return ret
	}
