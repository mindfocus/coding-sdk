...
var _ MappedNullable = &DescribeUsersOnResourceAndGrantObjectGrantInfo{}
...
type DescribeUsersOnResourceAndGrantObjectGrantInfo struct {
	// 授权对象 ID
	GrantObjectId NullableString `json:"GrantObjectId"`
	// 授权对象类型：USER,USER_GROUP,DEPARTMENT
	GrantScope NullableString `json:"GrantScope"`
}
...
func NewDescribeUsersOnResourceAndGrantObjectGrantInfoWithDefaults() *DescribeUsersOnResourceAndGrantObjectGrantInfo {
	...
	this.GrantObjectId = *NewNullableString(&grantObjectId)
	var grantScope GRANT_SCOPE = ""
	this.GrantScope = *NewNullableString(&grantScope)
	return &this
}
