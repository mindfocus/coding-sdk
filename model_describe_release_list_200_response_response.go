...
// checks if the DescribeReleaseList200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeReleaseList200ResponseResponse{}

// DescribeReleaseList200ResponseResponse 公共返回体
type DescribeReleaseList200ResponseResponse struct {
	Data *OpenApiReleaseListDataWithPage `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeReleaseList200ResponseResponse() *DescribeReleaseList200ResponseResponse {
	this := DescribeReleaseList200ResponseResponse{}
...
func (o *DescribeReleaseList200ResponseResponse) GetData() OpenApiReleaseListDataWithPage {
	if o == nil || IsNil(o.Data) {
		var ret OpenApiReleaseListDataWithPage
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given OpenApiReleaseListDataWithPage and assigns it to the Data field.
...
func (o DescribeReleaseList200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeReleaseList200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeReleaseList200ResponseResponse struct {
	value *DescribeReleaseList200ResponseResponse
	isSet bool
}

func (v NullableDescribeReleaseList200ResponseResponse) Get() *DescribeReleaseList200ResponseResponse {
	return v.value
}

func (v *NullableDescribeReleaseList200ResponseResponse) Set(val *DescribeReleaseList200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeReleaseList200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeReleaseList200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeReleaseList200ResponseResponse(val *DescribeReleaseList200ResponseResponse) *NullableDescribeReleaseList200ResponseResponse {
	return &NullableDescribeReleaseList200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeReleaseList200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeReleaseList200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
