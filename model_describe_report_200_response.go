...
// checks if the DescribeReport200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeReport200Response{}

// DescribeReport200Response struct for DescribeReport200Response
type DescribeReport200Response struct {
	Response *DescribeReport200ResponseResponse `json:"Response,omitempty"`
}
...
func NewDescribeReport200Response() *DescribeReport200Response {
	this := DescribeReport200Response{}
	return &this
}
...
func (o *DescribeReport200Response) GetResponse() DescribeReport200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret DescribeReport200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given DescribeReport200ResponseResponse and assigns it to the Response field.
func (o *DescribeReport200Response) SetResponse(v DescribeReport200ResponseResponse) {
	o.Response = &v
}

func (o DescribeReport200Response) MarshalJSON() ([]byte, error) {
...
func (o DescribeReport200Response) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeReport200Response struct {
	value *DescribeReport200Response
	isSet bool
}

func (v NullableDescribeReport200Response) Get() *DescribeReport200Response {
	return v.value
}

func (v *NullableDescribeReport200Response) Set(val *DescribeReport200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeReport200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeReport200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeReport200Response(val *DescribeReport200Response) *NullableDescribeReport200Response {
	return &NullableDescribeReport200Response{value: val, isSet: true}
}

func (v NullableDescribeReport200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeReport200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
