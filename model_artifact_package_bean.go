...
var _ MappedNullable = &ArtifactPackageBean{}
...
func (o *ArtifactPackageBean) GetLatestVersionName() string {
	if o == nil || IsNil(o.LatestVersionName) {
		var ret string
		return ret
	}
...
func (o *ArtifactPackageBean) GetLatestVersionReleaseStatus() int64 {
	if o == nil || IsNil(o.LatestVersionReleaseStatus) {
		var ret int64
		return ret
	}
...
func (o *ArtifactPackageBean) GetReleaseStrategy() int64 {
	if o == nil || IsNil(o.ReleaseStrategy) {
		var ret int64
		return ret
	}
