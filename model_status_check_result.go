...
var _ MappedNullable = &StatusCheckResult{}
...
type StatusCheckResult struct {
	...
	// 记录创建时间
	CreateDate NullableInt64 `json:"CreateDate,omitempty"`
	// 仓库路径
...
func NewStatusCheckResult() *StatusCheckResult {
	...
	var context string = ""
	this.Context = *NewNullableString(&context)
	var description string = ""
	this.Description = *NewNullableString(&description)
	var state string = ""
	this.State = *NewNullableString(&state)
	var targetURL string = ""
	this.TargetURL = *NewNullableString(&targetURL)
	return &this
}
...
func (o *StatusCheckResult) GetCreateDate() int64 {
	if o == nil || IsNil(o.CreateDate.Get()) {
		var ret int64
		return ret
	}
...
// SetCreateDate gets a reference to the given NullableInt64 and assigns it to the CreateDate field.
