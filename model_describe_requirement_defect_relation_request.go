...
// checks if the DescribeRequirementDefectRelationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeRequirementDefectRelationRequest{}

// DescribeRequirementDefectRelationRequest struct for DescribeRequirementDefectRelationRequest
type DescribeRequirementDefectRelationRequest struct {
	// 项目名称
...
type _DescribeRequirementDefectRelationRequest DescribeRequirementDefectRelationRequest
...
func NewDescribeRequirementDefectRelationRequest(projectName string, requirementCode int64) *DescribeRequirementDefectRelationRequest {
	this := DescribeRequirementDefectRelationRequest{}
...
func (o DescribeRequirementDefectRelationRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeRequirementDefectRelationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeRequirementDefectRelationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeRequirementDefectRelationRequest := _DescribeRequirementDefectRelationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeRequirementDefectRelationRequest)

	if err != nil {
		return err
	}

	*o = DescribeRequirementDefectRelationRequest(varDescribeRequirementDefectRelationRequest)

	return err
}

type NullableDescribeRequirementDefectRelationRequest struct {
	value *DescribeRequirementDefectRelationRequest
	isSet bool
}

func (v NullableDescribeRequirementDefectRelationRequest) Get() *DescribeRequirementDefectRelationRequest {
	return v.value
}

func (v *NullableDescribeRequirementDefectRelationRequest) Set(val *DescribeRequirementDefectRelationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeRequirementDefectRelationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeRequirementDefectRelationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeRequirementDefectRelationRequest(val *DescribeRequirementDefectRelationRequest) *NullableDescribeRequirementDefectRelationRequest {
	return &NullableDescribeRequirementDefectRelationRequest{value: val, isSet: true}
}

func (v NullableDescribeRequirementDefectRelationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeRequirementDefectRelationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
