...
// checks if the DescribeCdApplications200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCdApplications200ResponseResponse{}

// DescribeCdApplications200ResponseResponse 公共返回体
type DescribeCdApplications200ResponseResponse struct {
	Data *DescribeCdApplicationsResponseData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeCdApplications200ResponseResponse() *DescribeCdApplications200ResponseResponse {
	this := DescribeCdApplications200ResponseResponse{}
...
func (o *DescribeCdApplications200ResponseResponse) GetData() DescribeCdApplicationsResponseData {
	if o == nil || IsNil(o.Data) {
		var ret DescribeCdApplicationsResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DescribeCdApplicationsResponseData and assigns it to the Data field.
...
func (o DescribeCdApplications200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeCdApplications200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCdApplications200ResponseResponse struct {
	value *DescribeCdApplications200ResponseResponse
	isSet bool
}

func (v NullableDescribeCdApplications200ResponseResponse) Get() *DescribeCdApplications200ResponseResponse {
	return v.value
}

func (v *NullableDescribeCdApplications200ResponseResponse) Set(val *DescribeCdApplications200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCdApplications200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCdApplications200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCdApplications200ResponseResponse(val *DescribeCdApplications200ResponseResponse) *NullableDescribeCdApplications200ResponseResponse {
	return &NullableDescribeCdApplications200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeCdApplications200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCdApplications200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
