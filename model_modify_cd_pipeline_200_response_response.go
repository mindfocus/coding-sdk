...
// checks if the ModifyCdPipeline200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyCdPipeline200ResponseResponse{}

// ModifyCdPipeline200ResponseResponse 公共返回体
type ModifyCdPipeline200ResponseResponse struct {
	Data *ModifyCdPipelineResponseData `json:"Data,omitempty"`
	// 请求id
...
func NewModifyCdPipeline200ResponseResponse() *ModifyCdPipeline200ResponseResponse {
	this := ModifyCdPipeline200ResponseResponse{}
...
func (o *ModifyCdPipeline200ResponseResponse) GetData() ModifyCdPipelineResponseData {
	if o == nil || IsNil(o.Data) {
		var ret ModifyCdPipelineResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given ModifyCdPipelineResponseData and assigns it to the Data field.
...
func (o ModifyCdPipeline200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o ModifyCdPipeline200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModifyCdPipeline200ResponseResponse struct {
	value *ModifyCdPipeline200ResponseResponse
	isSet bool
}

func (v NullableModifyCdPipeline200ResponseResponse) Get() *ModifyCdPipeline200ResponseResponse {
	return v.value
}

func (v *NullableModifyCdPipeline200ResponseResponse) Set(val *ModifyCdPipeline200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyCdPipeline200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyCdPipeline200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyCdPipeline200ResponseResponse(val *ModifyCdPipeline200ResponseResponse) *NullableModifyCdPipeline200ResponseResponse {
	return &NullableModifyCdPipeline200ResponseResponse{value: val, isSet: true}
}

func (v NullableModifyCdPipeline200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyCdPipeline200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
