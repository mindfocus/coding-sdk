...
// checks if the DeleteProgramMemberPolicy200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteProgramMemberPolicy200ResponseResponse{}

// DeleteProgramMemberPolicy200ResponseResponse 公共返回体
type DeleteProgramMemberPolicy200ResponseResponse struct {
...
func NewDeleteProgramMemberPolicy200ResponseResponse() *DeleteProgramMemberPolicy200ResponseResponse {
	this := DeleteProgramMemberPolicy200ResponseResponse{}
...
func (o DeleteProgramMemberPolicy200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DeleteProgramMemberPolicy200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDeleteProgramMemberPolicy200ResponseResponse struct {
	value *DeleteProgramMemberPolicy200ResponseResponse
	isSet bool
}

func (v NullableDeleteProgramMemberPolicy200ResponseResponse) Get() *DeleteProgramMemberPolicy200ResponseResponse {
	return v.value
}

func (v *NullableDeleteProgramMemberPolicy200ResponseResponse) Set(val *DeleteProgramMemberPolicy200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteProgramMemberPolicy200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteProgramMemberPolicy200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteProgramMemberPolicy200ResponseResponse(val *DeleteProgramMemberPolicy200ResponseResponse) *NullableDeleteProgramMemberPolicy200ResponseResponse {
	return &NullableDeleteProgramMemberPolicy200ResponseResponse{value: val, isSet: true}
}

func (v NullableDeleteProgramMemberPolicy200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteProgramMemberPolicy200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
