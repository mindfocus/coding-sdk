...
// checks if the DescribeGitBlobRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitBlobRequest{}

// DescribeGitBlobRequest struct for DescribeGitBlobRequest
type DescribeGitBlobRequest struct {
	// Blob ID
...
type _DescribeGitBlobRequest DescribeGitBlobRequest
...
func (o DescribeGitBlobRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitBlobRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeGitBlobRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeGitBlobRequest := _DescribeGitBlobRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeGitBlobRequest)

	if err != nil {
		return err
	}

	*o = DescribeGitBlobRequest(varDescribeGitBlobRequest)

	return err
}

type NullableDescribeGitBlobRequest struct {
	value *DescribeGitBlobRequest
	isSet bool
}

func (v NullableDescribeGitBlobRequest) Get() *DescribeGitBlobRequest {
	return v.value
}

func (v *NullableDescribeGitBlobRequest) Set(val *DescribeGitBlobRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitBlobRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitBlobRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitBlobRequest(val *DescribeGitBlobRequest) *NullableDescribeGitBlobRequest {
	return &NullableDescribeGitBlobRequest{value: val, isSet: true}
}

func (v NullableDescribeGitBlobRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitBlobRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
