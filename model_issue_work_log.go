...
var _ MappedNullable = &IssueWorkLog{}
...
func (o *IssueWorkLog) GetRemainingHours() float32 {
	if o == nil || IsNil(o.RemainingHours) {
		var ret float32
		return ret
	}
...
func (o IssueWorkLog) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecordHours) {
		toSerialize["RecordHours"] = o.RecordHours
	}
	if !IsNil(o.RemainingHours) {
