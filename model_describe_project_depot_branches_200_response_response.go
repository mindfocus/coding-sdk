...
// checks if the DescribeProjectDepotBranches200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeProjectDepotBranches200ResponseResponse{}

// DescribeProjectDepotBranches200ResponseResponse 公共返回体
type DescribeProjectDepotBranches200ResponseResponse struct {
	Data *DepotDetailData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeProjectDepotBranches200ResponseResponse() *DescribeProjectDepotBranches200ResponseResponse {
	this := DescribeProjectDepotBranches200ResponseResponse{}
...
// SetData gets a reference to the given DepotDetailData and assigns it to the Data field.
...
func (o DescribeProjectDepotBranches200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeProjectDepotBranches200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeProjectDepotBranches200ResponseResponse struct {
	value *DescribeProjectDepotBranches200ResponseResponse
	isSet bool
}

func (v NullableDescribeProjectDepotBranches200ResponseResponse) Get() *DescribeProjectDepotBranches200ResponseResponse {
	return v.value
}

func (v *NullableDescribeProjectDepotBranches200ResponseResponse) Set(val *DescribeProjectDepotBranches200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeProjectDepotBranches200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeProjectDepotBranches200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeProjectDepotBranches200ResponseResponse(val *DescribeProjectDepotBranches200ResponseResponse) *NullableDescribeProjectDepotBranches200ResponseResponse {
	return &NullableDescribeProjectDepotBranches200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeProjectDepotBranches200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeProjectDepotBranches200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
