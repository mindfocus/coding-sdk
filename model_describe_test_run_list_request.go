...
var _ MappedNullable = &DescribeTestRunListRequest{}
...
func (o *DescribeTestRunListRequest) GetGitReleaseState() int32 {
	if o == nil || IsNil(o.GitReleaseState) {
		var ret int32
		return ret
	}
...
func (o *DescribeTestRunListRequest) GetIterationStatus() []string {
	if o == nil || IsNil(o.IterationStatus) {
		var ret []string
		return ret
	}
