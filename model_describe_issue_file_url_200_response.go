...
// checks if the DescribeIssueFileUrl200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeIssueFileUrl200Response{}

// DescribeIssueFileUrl200Response struct for DescribeIssueFileUrl200Response
type DescribeIssueFileUrl200Response struct {
	Response *DescribeIssueFileUrl200ResponseResponse `json:"Response,omitempty"`
}
...
func NewDescribeIssueFileUrl200Response() *DescribeIssueFileUrl200Response {
	this := DescribeIssueFileUrl200Response{}
	return &this
}
...
func (o *DescribeIssueFileUrl200Response) GetResponse() DescribeIssueFileUrl200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret DescribeIssueFileUrl200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given DescribeIssueFileUrl200ResponseResponse and assigns it to the Response field.
func (o *DescribeIssueFileUrl200Response) SetResponse(v DescribeIssueFileUrl200ResponseResponse) {
	o.Response = &v
}

func (o DescribeIssueFileUrl200Response) MarshalJSON() ([]byte, error) {
...
func (o DescribeIssueFileUrl200Response) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeIssueFileUrl200Response struct {
	value *DescribeIssueFileUrl200Response
	isSet bool
}

func (v NullableDescribeIssueFileUrl200Response) Get() *DescribeIssueFileUrl200Response {
	return v.value
}

func (v *NullableDescribeIssueFileUrl200Response) Set(val *DescribeIssueFileUrl200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeIssueFileUrl200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeIssueFileUrl200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeIssueFileUrl200Response(val *DescribeIssueFileUrl200Response) *NullableDescribeIssueFileUrl200Response {
	return &NullableDescribeIssueFileUrl200Response{value: val, isSet: true}
}

func (v NullableDescribeIssueFileUrl200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeIssueFileUrl200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
