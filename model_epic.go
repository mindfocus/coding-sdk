...
type Epic struct {
	...
	// 事项状态 Id
	IssueStatusId NullableInt64 `json:"IssueStatusId,omitempty"`
	// 事项状态名称
	IssueStatusName NullableString `json:"IssueStatusName,omitempty"`
	// 名称
...
func NewEpic() *Epic {
	...
	this.IssueStatusName = *NewNullableString(&issueStatusName)
	var name string = ""
	this.Name = &name
	var priority string = ""
...
func (o *Epic) GetIssueStatusId() int64 {
	if o == nil || IsNil(o.IssueStatusId.Get()) {
		var ret int64
		return ret
	}
...
// SetIssueStatusId gets a reference to the given NullableInt64 and assigns it to the IssueStatusId field.
...
func (o *Epic) GetIssueStatusName() string {
	if o == nil || IsNil(o.IssueStatusName.Get()) {
		var ret string
		return ret
	}
...
// SetIssueStatusName gets a reference to the given NullableString and assigns it to the IssueStatusName field.
