...
// checks if the CreateCdTask200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCdTask200Response{}

// CreateCdTask200Response struct for CreateCdTask200Response
type CreateCdTask200Response struct {
	Response *CreateCdTask200ResponseResponse `json:"Response,omitempty"`
}
...
func (o *CreateCdTask200Response) GetResponse() CreateCdTask200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret CreateCdTask200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given CreateCdTask200ResponseResponse and assigns it to the Response field.
func (o *CreateCdTask200Response) SetResponse(v CreateCdTask200ResponseResponse) {
	o.Response = &v
}

func (o CreateCdTask200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateCdTask200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCdTask200Response struct {
	value *CreateCdTask200Response
	isSet bool
}

func (v NullableCreateCdTask200Response) Get() *CreateCdTask200Response {
	return v.value
}

func (v *NullableCreateCdTask200Response) Set(val *CreateCdTask200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCdTask200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCdTask200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCdTask200Response(val *CreateCdTask200Response) *NullableCreateCdTask200Response {
	return &NullableCreateCdTask200Response{value: val, isSet: true}
}

func (v NullableCreateCdTask200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCdTask200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
