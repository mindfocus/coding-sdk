...
type PageInfo struct {
	// 页码数量
	PageNumber NullableInt64 `json:"PageNumber,omitempty"`
	// 每页大小
	PageSize NullableInt64 `json:"PageSize,omitempty"`
	// 页码总数量
	TotalPage NullableInt64 `json:"TotalPage,omitempty"`
	// 数据总行数
	TotalRow NullableInt64 `json:"TotalRow,omitempty"`
}
...
// SetPageNumber gets a reference to the given NullableInt64 and assigns it to the PageNumber field.
...
// SetTotalRow gets a reference to the given NullableInt64 and assigns it to the TotalRow field.
