...
var _ MappedNullable = &GitFilePushRule{}
...
func (o *GitFilePushRule) GetFilePushRuleId() int64 {
	if o == nil || IsNil(o.FilePushRuleId) {
		var ret int64
		return ret
	}
...
func (o *GitFilePushRule) GetIsDenyForAllUser() bool {
	if o == nil || IsNil(o.IsDenyForAllUser) {
		var ret bool
		return ret
	}
...
func (o GitFilePushRule) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FilePushRuleId) {
		toSerialize["FilePushRuleId"] = o.FilePushRuleId
	}
	if !IsNil(o.IsDenyForAllUser) {
