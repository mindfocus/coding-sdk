...
// checks if the ModifyGitFilesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyGitFilesRequest{}

// ModifyGitFilesRequest struct for ModifyGitFilesRequest
...
type _ModifyGitFilesRequest ModifyGitFilesRequest
...
func (o ModifyGitFilesRequest) MarshalJSON() ([]byte, error) {
...
func (o ModifyGitFilesRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ModifyGitFilesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varModifyGitFilesRequest := _ModifyGitFilesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varModifyGitFilesRequest)

	if err != nil {
		return err
	}

	*o = ModifyGitFilesRequest(varModifyGitFilesRequest)

	return err
}

type NullableModifyGitFilesRequest struct {
	value *ModifyGitFilesRequest
	isSet bool
}

func (v NullableModifyGitFilesRequest) Get() *ModifyGitFilesRequest {
	return v.value
}

func (v *NullableModifyGitFilesRequest) Set(val *ModifyGitFilesRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyGitFilesRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyGitFilesRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyGitFilesRequest(val *ModifyGitFilesRequest) *NullableModifyGitFilesRequest {
	return &NullableModifyGitFilesRequest{value: val, isSet: true}
}

func (v NullableModifyGitFilesRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyGitFilesRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
