...
// checks if the DescribeCdDeployTimeByProjectResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCdDeployTimeByProjectResponseData{}

// DescribeCdDeployTimeByProjectResponseData DescribeCdDeployTimeByProjectResponseData 结构
type DescribeCdDeployTimeByProjectResponseData struct {
	// 各应用发布时长详情
...
func NewDescribeCdDeployTimeByProjectResponseData() *DescribeCdDeployTimeByProjectResponseData {
	this := DescribeCdDeployTimeByProjectResponseData{}
	var endDate string = ""
...
func (o DescribeCdDeployTimeByProjectResponseData) MarshalJSON() ([]byte, error) {
...
func (o DescribeCdDeployTimeByProjectResponseData) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCdDeployTimeByProjectResponseData struct {
	value *DescribeCdDeployTimeByProjectResponseData
	isSet bool
}

func (v NullableDescribeCdDeployTimeByProjectResponseData) Get() *DescribeCdDeployTimeByProjectResponseData {
	return v.value
}

func (v *NullableDescribeCdDeployTimeByProjectResponseData) Set(val *DescribeCdDeployTimeByProjectResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCdDeployTimeByProjectResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCdDeployTimeByProjectResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCdDeployTimeByProjectResponseData(val *DescribeCdDeployTimeByProjectResponseData) *NullableDescribeCdDeployTimeByProjectResponseData {
	return &NullableDescribeCdDeployTimeByProjectResponseData{value: val, isSet: true}
}

func (v NullableDescribeCdDeployTimeByProjectResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCdDeployTimeByProjectResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
