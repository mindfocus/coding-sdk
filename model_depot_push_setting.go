...
var _ MappedNullable = &DepotPushSetting{}

// DepotPushSetting 仓库推送规则信息
type DepotPushSetting struct {
	// 检查 Git 提交的提交者 (Committer) 和提交作者 (Author) 必须是已验证的邮箱。
	CheckCommitAuthor NullableBool `json:"CheckCommitAuthor,omitempty"`
	// Git 提交信息的格式校验
	CommitMessageMustMatchRegex NullableString `json:"CommitMessageMustMatchRegex,omitempty"`
	// 禁止强制推送 (Force Push)
	DenyForcePush NullableBool `json:"DenyForcePush,omitempty"`
	// 禁止推送的文件（文件类型用换行符隔开）
	PushDenyFile NullableString `json:"PushDenyFile,omitempty"`
	// 开启单次提交的文件总大小限制，Git LFS 文件除外（单位MB）
	PushFileSize NullableString `json:"PushFileSize,omitempty"`
}
...
func NewDepotPushSetting() *DepotPushSetting {
	...
	this.CheckCommitAuthor = *NewNullableBool(&checkCommitAuthor)
	var commitMessageMustMatchRegex string = ""
	this.CommitMessageMustMatchRegex = *NewNullableString(&commitMessageMustMatchRegex)
	var denyForcePush bool = false
	this.DenyForcePush = *NewNullableBool(&denyForcePush)
	var pushDenyFile string = ""
	this.PushDenyFile = *NewNullableString(&pushDenyFile)
	var pushFileSize string = ""
	this.PushFileSize = *NewNullableString(&pushFileSize)
	return &this
}
...
func (o *DepotPushSetting) GetCheckCommitAuthor() bool {
	if o == nil || IsNil(o.CheckCommitAuthor.Get()) {
		var ret bool
		return ret
	}
...
// SetCheckCommitAuthor gets a reference to the given NullableBool and assigns it to the CheckCommitAuthor field.
...
func (o *DepotPushSetting) GetCommitMessageMustMatchRegex() string {
	if o == nil || IsNil(o.CommitMessageMustMatchRegex.Get()) {
		var ret string
		return ret
	}
...
// SetCommitMessageMustMatchRegex gets a reference to the given NullableString and assigns it to the CommitMessageMustMatchRegex field.
...
func (o *DepotPushSetting) GetDenyForcePush() bool {
	if o == nil || IsNil(o.DenyForcePush.Get()) {
		var ret bool
		return ret
	}
...
// SetDenyForcePush gets a reference to the given NullableBool and assigns it to the DenyForcePush field.
...
func (o *DepotPushSetting) GetPushDenyFile() string {
	if o == nil || IsNil(o.PushDenyFile.Get()) {
		var ret string
		return ret
	}
...
// SetPushDenyFile gets a reference to the given NullableString and assigns it to the PushDenyFile field.
...
func (o *DepotPushSetting) GetPushFileSize() string {
	if o == nil || IsNil(o.PushFileSize.Get()) {
		var ret string
		return ret
	}
...
// SetPushFileSize gets a reference to the given NullableString and assigns it to the PushFileSize field.
