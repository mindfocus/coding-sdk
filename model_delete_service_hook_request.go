...
// checks if the DeleteServiceHookRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteServiceHookRequest{}

// DeleteServiceHookRequest struct for DeleteServiceHookRequest
type DeleteServiceHookRequest struct {
	// Service Hook 编号
	Id []string `json:"Id"`
	// 项目编号或者研发空间编号
...
type _DeleteServiceHookRequest DeleteServiceHookRequest
...
func (o DeleteServiceHookRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteServiceHookRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteServiceHookRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteServiceHookRequest := _DeleteServiceHookRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteServiceHookRequest)

	if err != nil {
		return err
	}

	*o = DeleteServiceHookRequest(varDeleteServiceHookRequest)

	return err
}

type NullableDeleteServiceHookRequest struct {
	value *DeleteServiceHookRequest
	isSet bool
}

func (v NullableDeleteServiceHookRequest) Get() *DeleteServiceHookRequest {
	return v.value
}

func (v *NullableDeleteServiceHookRequest) Set(val *DeleteServiceHookRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteServiceHookRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteServiceHookRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteServiceHookRequest(val *DeleteServiceHookRequest) *NullableDeleteServiceHookRequest {
	return &NullableDeleteServiceHookRequest{value: val, isSet: true}
}

func (v NullableDeleteServiceHookRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteServiceHookRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
