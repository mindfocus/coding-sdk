...
var _ MappedNullable = &CreateTestRunRequest{}
...
func (o *CreateTestRunRequest) GetConfigEnvironmentId() int32 {
	if o == nil || IsNil(o.ConfigEnvironmentId) {
		var ret int32
		return ret
	}
