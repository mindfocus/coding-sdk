...
// checks if the ModifyTestRun200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyTestRun200ResponseResponse{}

// ModifyTestRun200ResponseResponse 公共返回体
type ModifyTestRun200ResponseResponse struct {
...
func NewModifyTestRun200ResponseResponse() *ModifyTestRun200ResponseResponse {
	this := ModifyTestRun200ResponseResponse{}
...
// SetData gets a reference to the given RunData and assigns it to the Data field.
...
func (o ModifyTestRun200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o ModifyTestRun200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModifyTestRun200ResponseResponse struct {
	value *ModifyTestRun200ResponseResponse
	isSet bool
}

func (v NullableModifyTestRun200ResponseResponse) Get() *ModifyTestRun200ResponseResponse {
	return v.value
}

func (v *NullableModifyTestRun200ResponseResponse) Set(val *ModifyTestRun200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyTestRun200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyTestRun200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyTestRun200ResponseResponse(val *ModifyTestRun200ResponseResponse) *NullableModifyTestRun200ResponseResponse {
	return &NullableModifyTestRun200ResponseResponse{value: val, isSet: true}
}

func (v NullableModifyTestRun200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyTestRun200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
