...
// checks if the DescribeCodingCIBuildLog200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCodingCIBuildLog200ResponseResponse{}

// DescribeCodingCIBuildLog200ResponseResponse 公共返回体
type DescribeCodingCIBuildLog200ResponseResponse struct {
	Data *DescribeCodingCIBuildLogData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeCodingCIBuildLog200ResponseResponse() *DescribeCodingCIBuildLog200ResponseResponse {
	this := DescribeCodingCIBuildLog200ResponseResponse{}
...
func (o *DescribeCodingCIBuildLog200ResponseResponse) GetData() DescribeCodingCIBuildLogData {
	if o == nil || IsNil(o.Data) {
		var ret DescribeCodingCIBuildLogData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DescribeCodingCIBuildLogData and assigns it to the Data field.
...
func (o DescribeCodingCIBuildLog200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeCodingCIBuildLog200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCodingCIBuildLog200ResponseResponse struct {
	value *DescribeCodingCIBuildLog200ResponseResponse
	isSet bool
}

func (v NullableDescribeCodingCIBuildLog200ResponseResponse) Get() *DescribeCodingCIBuildLog200ResponseResponse {
	return v.value
}

func (v *NullableDescribeCodingCIBuildLog200ResponseResponse) Set(val *DescribeCodingCIBuildLog200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCodingCIBuildLog200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCodingCIBuildLog200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCodingCIBuildLog200ResponseResponse(val *DescribeCodingCIBuildLog200ResponseResponse) *NullableDescribeCodingCIBuildLog200ResponseResponse {
	return &NullableDescribeCodingCIBuildLog200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeCodingCIBuildLog200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCodingCIBuildLog200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
