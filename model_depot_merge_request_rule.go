...
var _ MappedNullable = &DepotMergeRequestRule{}

// DepotMergeRequestRule 仓库规范的合并方向规则
type DepotMergeRequestRule struct {
	// 源分支类型名字
	SourceBranchTypeName NullableString `json:"SourceBranchTypeName,omitempty"`
	// 源分支类型规则
	SourceBranchTypeRule NullableString `json:"SourceBranchTypeRule,omitempty"`
	// 目标分支类型名字
	TargetBranchTypeName NullableString `json:"TargetBranchTypeName,omitempty"`
	// 目标分支类型规则
	TargetBranchTypeRule NullableString `json:"TargetBranchTypeRule,omitempty"`
}
...
func NewDepotMergeRequestRule() *DepotMergeRequestRule {
	...
	this.SourceBranchTypeName = *NewNullableString(&sourceBranchTypeName)
	var sourceBranchTypeRule string = ""
	this.SourceBranchTypeRule = *NewNullableString(&sourceBranchTypeRule)
	var targetBranchTypeName string = ""
	this.TargetBranchTypeName = *NewNullableString(&targetBranchTypeName)
	var targetBranchTypeRule string = ""
	this.TargetBranchTypeRule = *NewNullableString(&targetBranchTypeRule)
	return &this
}
...
func (o *DepotMergeRequestRule) GetSourceBranchTypeName() string {
	if o == nil || IsNil(o.SourceBranchTypeName.Get()) {
		var ret string
		return ret
	}
...
// SetSourceBranchTypeName gets a reference to the given NullableString and assigns it to the SourceBranchTypeName field.
...
func (o *DepotMergeRequestRule) GetSourceBranchTypeRule() string {
	if o == nil || IsNil(o.SourceBranchTypeRule.Get()) {
		var ret string
		return ret
	}
...
// SetSourceBranchTypeRule gets a reference to the given NullableString and assigns it to the SourceBranchTypeRule field.
...
func (o *DepotMergeRequestRule) GetTargetBranchTypeName() string {
	if o == nil || IsNil(o.TargetBranchTypeName.Get()) {
		var ret string
		return ret
	}
...
// SetTargetBranchTypeName gets a reference to the given NullableString and assigns it to the TargetBranchTypeName field.
...
func (o *DepotMergeRequestRule) GetTargetBranchTypeRule() string {
	if o == nil || IsNil(o.TargetBranchTypeRule.Get()) {
		var ret string
		return ret
	}
...
// SetTargetBranchTypeRule gets a reference to the given NullableString and assigns it to the TargetBranchTypeRule field.
