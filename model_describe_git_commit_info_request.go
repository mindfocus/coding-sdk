...
// checks if the DescribeGitCommitInfoRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitCommitInfoRequest{}

// DescribeGitCommitInfoRequest struct for DescribeGitCommitInfoRequest
type DescribeGitCommitInfoRequest struct {
	// 仓库id
...
type _DescribeGitCommitInfoRequest DescribeGitCommitInfoRequest
...
func NewDescribeGitCommitInfoRequest(depotId int64, sha string) *DescribeGitCommitInfoRequest {
	this := DescribeGitCommitInfoRequest{}
...
func (o DescribeGitCommitInfoRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitCommitInfoRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeGitCommitInfoRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeGitCommitInfoRequest := _DescribeGitCommitInfoRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeGitCommitInfoRequest)

	if err != nil {
		return err
	}

	*o = DescribeGitCommitInfoRequest(varDescribeGitCommitInfoRequest)

	return err
}

type NullableDescribeGitCommitInfoRequest struct {
	value *DescribeGitCommitInfoRequest
	isSet bool
}

func (v NullableDescribeGitCommitInfoRequest) Get() *DescribeGitCommitInfoRequest {
	return v.value
}

func (v *NullableDescribeGitCommitInfoRequest) Set(val *DescribeGitCommitInfoRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitCommitInfoRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitCommitInfoRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitCommitInfoRequest(val *DescribeGitCommitInfoRequest) *NullableDescribeGitCommitInfoRequest {
	return &NullableDescribeGitCommitInfoRequest{value: val, isSet: true}
}

func (v NullableDescribeGitCommitInfoRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitCommitInfoRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
