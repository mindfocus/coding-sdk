...
var _ MappedNullable = &MergeInfo{}
...
type MergeInfo struct {
	...
	// 合并请求URl
	MergeRequestUrl NullableString `json:"MergeRequestUrl,omitempty"`
	// 项目id
...
func NewMergeInfo() *MergeInfo {
	...
	this.MergeRequestUrl = *NewNullableString(&mergeRequestUrl)
	return &this
}
...
func (o *MergeInfo) GetMergeRequestId() int64 {
	if o == nil || IsNil(o.MergeRequestId) {
		var ret int64
		return ret
	}
...
func (o *MergeInfo) GetMergeRequestInfo() MergeRequestInfo {
	if o == nil || IsNil(o.MergeRequestInfo) {
...
func (o *MergeInfo) GetMergeRequestUrl() string {
	if o == nil || IsNil(o.MergeRequestUrl.Get()) {
		var ret string
		return ret
	}
...
// SetMergeRequestUrl gets a reference to the given NullableString and assigns it to the MergeRequestUrl field.
...
func (o MergeInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MergeRequestId) {
		toSerialize["MergeRequestId"] = o.MergeRequestId
	}
	if !IsNil(o.MergeRequestInfo) {
