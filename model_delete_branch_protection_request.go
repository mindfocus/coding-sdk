...
// checks if the DeleteBranchProtectionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteBranchProtectionRequest{}

// DeleteBranchProtectionRequest struct for DeleteBranchProtectionRequest
...
type _DeleteBranchProtectionRequest DeleteBranchProtectionRequest
...
func NewDeleteBranchProtectionRequest(branchProtectionId int64, depotId int64) *DeleteBranchProtectionRequest {
	this := DeleteBranchProtectionRequest{}
...
func (o DeleteBranchProtectionRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteBranchProtectionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteBranchProtectionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteBranchProtectionRequest := _DeleteBranchProtectionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteBranchProtectionRequest)

	if err != nil {
		return err
	}

	*o = DeleteBranchProtectionRequest(varDeleteBranchProtectionRequest)

	return err
}

type NullableDeleteBranchProtectionRequest struct {
	value *DeleteBranchProtectionRequest
	isSet bool
}

func (v NullableDeleteBranchProtectionRequest) Get() *DeleteBranchProtectionRequest {
	return v.value
}

func (v *NullableDeleteBranchProtectionRequest) Set(val *DeleteBranchProtectionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBranchProtectionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBranchProtectionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBranchProtectionRequest(val *DeleteBranchProtectionRequest) *NullableDeleteBranchProtectionRequest {
	return &NullableDeleteBranchProtectionRequest{value: val, isSet: true}
}

func (v NullableDeleteBranchProtectionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBranchProtectionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
