...
// checks if the DescribeGitDepotRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitDepotRequest{}

// DescribeGitDepotRequest struct for DescribeGitDepotRequest
...
type _DescribeGitDepotRequest DescribeGitDepotRequest
...
func (o DescribeGitDepotRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitDepotRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeGitDepotRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeGitDepotRequest := _DescribeGitDepotRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeGitDepotRequest)

	if err != nil {
		return err
	}

	*o = DescribeGitDepotRequest(varDescribeGitDepotRequest)

	return err
}

type NullableDescribeGitDepotRequest struct {
	value *DescribeGitDepotRequest
	isSet bool
}

func (v NullableDescribeGitDepotRequest) Get() *DescribeGitDepotRequest {
	return v.value
}

func (v *NullableDescribeGitDepotRequest) Set(val *DescribeGitDepotRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitDepotRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitDepotRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitDepotRequest(val *DescribeGitDepotRequest) *NullableDescribeGitDepotRequest {
	return &NullableDescribeGitDepotRequest{value: val, isSet: true}
}

func (v NullableDescribeGitDepotRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitDepotRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
