...
var _ MappedNullable = &DescribeGrantObjectsOnResourcePageData{}
...
type DescribeGrantObjectsOnResourcePageData struct {
	...
	// 请求页数
	PageNumber NullableInt64 `json:"PageNumber"`
	// 请求条数
	PageSize NullableInt64 `json:"PageSize"`
	// 总条数
	TotalCount NullableInt64 `json:"TotalCount"`
}
...
func (o *DescribeGrantObjectsOnResourcePageData) GetGrantObjectListOk() ([]GrantObjectInfo, bool) {
	if o == nil || IsNil(o.GrantObjectList) {
		return nil, false
	}
