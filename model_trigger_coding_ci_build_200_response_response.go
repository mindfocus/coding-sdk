...
// checks if the TriggerCodingCIBuild200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerCodingCIBuild200ResponseResponse{}

// TriggerCodingCIBuild200ResponseResponse 公共返回体
type TriggerCodingCIBuild200ResponseResponse struct {
	Data *TriggerCodingCIBuildData `json:"Data,omitempty"`
	// 请求id
...
func NewTriggerCodingCIBuild200ResponseResponse() *TriggerCodingCIBuild200ResponseResponse {
	this := TriggerCodingCIBuild200ResponseResponse{}
...
func (o *TriggerCodingCIBuild200ResponseResponse) GetData() TriggerCodingCIBuildData {
	if o == nil || IsNil(o.Data) {
		var ret TriggerCodingCIBuildData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given TriggerCodingCIBuildData and assigns it to the Data field.
...
func (o TriggerCodingCIBuild200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o TriggerCodingCIBuild200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTriggerCodingCIBuild200ResponseResponse struct {
	value *TriggerCodingCIBuild200ResponseResponse
	isSet bool
}

func (v NullableTriggerCodingCIBuild200ResponseResponse) Get() *TriggerCodingCIBuild200ResponseResponse {
	return v.value
}

func (v *NullableTriggerCodingCIBuild200ResponseResponse) Set(val *TriggerCodingCIBuild200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTriggerCodingCIBuild200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTriggerCodingCIBuild200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTriggerCodingCIBuild200ResponseResponse(val *TriggerCodingCIBuild200ResponseResponse) *NullableTriggerCodingCIBuild200ResponseResponse {
	return &NullableTriggerCodingCIBuild200ResponseResponse{value: val, isSet: true}
}

func (v NullableTriggerCodingCIBuild200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTriggerCodingCIBuild200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
