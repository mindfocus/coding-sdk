...
// checks if the CreateCdPipeline200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCdPipeline200ResponseResponse{}

// CreateCdPipeline200ResponseResponse 公共返回体
type CreateCdPipeline200ResponseResponse struct {
	Data *CreateCdPipelineResponseData `json:"Data,omitempty"`
	// 请求id
...
func NewCreateCdPipeline200ResponseResponse() *CreateCdPipeline200ResponseResponse {
	this := CreateCdPipeline200ResponseResponse{}
...
func (o *CreateCdPipeline200ResponseResponse) GetData() CreateCdPipelineResponseData {
	if o == nil || IsNil(o.Data) {
		var ret CreateCdPipelineResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given CreateCdPipelineResponseData and assigns it to the Data field.
...
func (o CreateCdPipeline200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateCdPipeline200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCdPipeline200ResponseResponse struct {
	value *CreateCdPipeline200ResponseResponse
	isSet bool
}

func (v NullableCreateCdPipeline200ResponseResponse) Get() *CreateCdPipeline200ResponseResponse {
	return v.value
}

func (v *NullableCreateCdPipeline200ResponseResponse) Set(val *CreateCdPipeline200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCdPipeline200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCdPipeline200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCdPipeline200ResponseResponse(val *CreateCdPipeline200ResponseResponse) *NullableCreateCdPipeline200ResponseResponse {
	return &NullableCreateCdPipeline200ResponseResponse{value: val, isSet: true}
}

func (v NullableCreateCdPipeline200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCdPipeline200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
