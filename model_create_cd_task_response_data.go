...
var _ MappedNullable = &CreateCdTaskResponseData{}
...
func (o *CreateCdTaskResponseData) GetTaskExecutionId() string {
	if o == nil || IsNil(o.TaskExecutionId) {
		var ret string
		return ret
	}
...
func (o *CreateCdTaskResponseData) GetTaskExecutionRef() string {
	if o == nil || IsNil(o.TaskExecutionRef) {
		var ret string
		return ret
	}
...
func (o CreateCdTaskResponseData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TaskExecutionId) {
		toSerialize["TaskExecutionId"] = o.TaskExecutionId
	}
	if !IsNil(o.TaskExecutionRef) {
