...
// checks if the DescribeAllMergeRequestNotes200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeAllMergeRequestNotes200ResponseResponse{}

// DescribeAllMergeRequestNotes200ResponseResponse 公共返回体
type DescribeAllMergeRequestNotes200ResponseResponse struct {
	// 行评论内容
...
func NewDescribeAllMergeRequestNotes200ResponseResponse() *DescribeAllMergeRequestNotes200ResponseResponse {
	this := DescribeAllMergeRequestNotes200ResponseResponse{}
...
func (o DescribeAllMergeRequestNotes200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeAllMergeRequestNotes200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeAllMergeRequestNotes200ResponseResponse struct {
	value *DescribeAllMergeRequestNotes200ResponseResponse
	isSet bool
}

func (v NullableDescribeAllMergeRequestNotes200ResponseResponse) Get() *DescribeAllMergeRequestNotes200ResponseResponse {
	return v.value
}

func (v *NullableDescribeAllMergeRequestNotes200ResponseResponse) Set(val *DescribeAllMergeRequestNotes200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeAllMergeRequestNotes200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeAllMergeRequestNotes200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeAllMergeRequestNotes200ResponseResponse(val *DescribeAllMergeRequestNotes200ResponseResponse) *NullableDescribeAllMergeRequestNotes200ResponseResponse {
	return &NullableDescribeAllMergeRequestNotes200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeAllMergeRequestNotes200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeAllMergeRequestNotes200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
