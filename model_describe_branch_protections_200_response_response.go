...
// checks if the DescribeBranchProtections200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeBranchProtections200ResponseResponse{}

// DescribeBranchProtections200ResponseResponse 公共返回体
type DescribeBranchProtections200ResponseResponse struct {
	// 保护分支规则列表
...
func NewDescribeBranchProtections200ResponseResponse() *DescribeBranchProtections200ResponseResponse {
	this := DescribeBranchProtections200ResponseResponse{}
...
// GetBranchProtections returns the BranchProtections field value if set, zero value otherwise.
func (o *DescribeBranchProtections200ResponseResponse) GetBranchProtections() []BranchProtection {
	if o == nil || IsNil(o.BranchProtections) {
		var ret []BranchProtection
		return ret
	}
	return o.BranchProtections
}

// GetBranchProtectionsOk returns a tuple with the BranchProtections field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DescribeBranchProtections200ResponseResponse) GetBranchProtectionsOk() ([]BranchProtection, bool) {
	if o == nil || IsNil(o.BranchProtections) {
		return nil, false
	}
	return o.BranchProtections, true
}
...
// SetBranchProtections gets a reference to the given []BranchProtection and assigns it to the BranchProtections field.
func (o *DescribeBranchProtections200ResponseResponse) SetBranchProtections(v []BranchProtection) {
	o.BranchProtections = v
}
...
func (o DescribeBranchProtections200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeBranchProtections200ResponseResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BranchProtections) {
		toSerialize["BranchProtections"] = o.BranchProtections
	}
...
type NullableDescribeBranchProtections200ResponseResponse struct {
	value *DescribeBranchProtections200ResponseResponse
	isSet bool
}

func (v NullableDescribeBranchProtections200ResponseResponse) Get() *DescribeBranchProtections200ResponseResponse {
	return v.value
}

func (v *NullableDescribeBranchProtections200ResponseResponse) Set(val *DescribeBranchProtections200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeBranchProtections200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeBranchProtections200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeBranchProtections200ResponseResponse(val *DescribeBranchProtections200ResponseResponse) *NullableDescribeBranchProtections200ResponseResponse {
	return &NullableDescribeBranchProtections200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeBranchProtections200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeBranchProtections200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
