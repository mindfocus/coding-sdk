...
// checks if the DescribeIterationList200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeIterationList200ResponseResponse{}

// DescribeIterationList200ResponseResponse 公共返回体
type DescribeIterationList200ResponseResponse struct {
	Data *DescribeIterationListData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeIterationList200ResponseResponse() *DescribeIterationList200ResponseResponse {
	this := DescribeIterationList200ResponseResponse{}
...
func (o *DescribeIterationList200ResponseResponse) GetData() DescribeIterationListData {
	if o == nil || IsNil(o.Data) {
		var ret DescribeIterationListData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DescribeIterationListData and assigns it to the Data field.
...
func (o DescribeIterationList200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeIterationList200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeIterationList200ResponseResponse struct {
	value *DescribeIterationList200ResponseResponse
	isSet bool
}

func (v NullableDescribeIterationList200ResponseResponse) Get() *DescribeIterationList200ResponseResponse {
	return v.value
}

func (v *NullableDescribeIterationList200ResponseResponse) Set(val *DescribeIterationList200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeIterationList200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeIterationList200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeIterationList200ResponseResponse(val *DescribeIterationList200ResponseResponse) *NullableDescribeIterationList200ResponseResponse {
	return &NullableDescribeIterationList200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeIterationList200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeIterationList200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
