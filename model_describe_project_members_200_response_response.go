...
// checks if the DescribeProjectMembers200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeProjectMembers200ResponseResponse{}

// DescribeProjectMembers200ResponseResponse 公共返回体
type DescribeProjectMembers200ResponseResponse struct {
...
func NewDescribeProjectMembers200ResponseResponse() *DescribeProjectMembers200ResponseResponse {
	this := DescribeProjectMembers200ResponseResponse{}
...
// SetData gets a reference to the given ProjectMemberData and assigns it to the Data field.
...
func (o DescribeProjectMembers200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeProjectMembers200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeProjectMembers200ResponseResponse struct {
	value *DescribeProjectMembers200ResponseResponse
	isSet bool
}

func (v NullableDescribeProjectMembers200ResponseResponse) Get() *DescribeProjectMembers200ResponseResponse {
	return v.value
}

func (v *NullableDescribeProjectMembers200ResponseResponse) Set(val *DescribeProjectMembers200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeProjectMembers200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeProjectMembers200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeProjectMembers200ResponseResponse(val *DescribeProjectMembers200ResponseResponse) *NullableDescribeProjectMembers200ResponseResponse {
	return &NullableDescribeProjectMembers200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeProjectMembers200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeProjectMembers200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
