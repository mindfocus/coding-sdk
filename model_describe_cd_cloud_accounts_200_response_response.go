...
// checks if the DescribeCdCloudAccounts200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCdCloudAccounts200ResponseResponse{}

// DescribeCdCloudAccounts200ResponseResponse 公共返回体
type DescribeCdCloudAccounts200ResponseResponse struct {
	Data *DescribeCdCloudAccountsResponseData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeCdCloudAccounts200ResponseResponse() *DescribeCdCloudAccounts200ResponseResponse {
	this := DescribeCdCloudAccounts200ResponseResponse{}
...
func (o *DescribeCdCloudAccounts200ResponseResponse) GetData() DescribeCdCloudAccountsResponseData {
	if o == nil || IsNil(o.Data) {
		var ret DescribeCdCloudAccountsResponseData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DescribeCdCloudAccountsResponseData and assigns it to the Data field.
...
func (o DescribeCdCloudAccounts200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeCdCloudAccounts200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCdCloudAccounts200ResponseResponse struct {
	value *DescribeCdCloudAccounts200ResponseResponse
	isSet bool
}

func (v NullableDescribeCdCloudAccounts200ResponseResponse) Get() *DescribeCdCloudAccounts200ResponseResponse {
	return v.value
}

func (v *NullableDescribeCdCloudAccounts200ResponseResponse) Set(val *DescribeCdCloudAccounts200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCdCloudAccounts200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCdCloudAccounts200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCdCloudAccounts200ResponseResponse(val *DescribeCdCloudAccounts200ResponseResponse) *NullableDescribeCdCloudAccounts200ResponseResponse {
	return &NullableDescribeCdCloudAccounts200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeCdCloudAccounts200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCdCloudAccounts200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
