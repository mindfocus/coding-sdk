...
// checks if the DescribeDepotMergeRequests200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeDepotMergeRequests200ResponseResponse{}

// DescribeDepotMergeRequests200ResponseResponse 公共返回体
type DescribeDepotMergeRequests200ResponseResponse struct {
	Data *DescribeMergeRequestsData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeDepotMergeRequests200ResponseResponse() *DescribeDepotMergeRequests200ResponseResponse {
	this := DescribeDepotMergeRequests200ResponseResponse{}
...
func (o *DescribeDepotMergeRequests200ResponseResponse) GetData() DescribeMergeRequestsData {
	if o == nil || IsNil(o.Data) {
		var ret DescribeMergeRequestsData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given DescribeMergeRequestsData and assigns it to the Data field.
...
func (o DescribeDepotMergeRequests200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeDepotMergeRequests200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeDepotMergeRequests200ResponseResponse struct {
	value *DescribeDepotMergeRequests200ResponseResponse
	isSet bool
}

func (v NullableDescribeDepotMergeRequests200ResponseResponse) Get() *DescribeDepotMergeRequests200ResponseResponse {
	return v.value
}

func (v *NullableDescribeDepotMergeRequests200ResponseResponse) Set(val *DescribeDepotMergeRequests200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeDepotMergeRequests200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeDepotMergeRequests200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeDepotMergeRequests200ResponseResponse(val *DescribeDepotMergeRequests200ResponseResponse) *NullableDescribeDepotMergeRequests200ResponseResponse {
	return &NullableDescribeDepotMergeRequests200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeDepotMergeRequests200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeDepotMergeRequests200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
