...
type ResourceReference struct {
	...
	// 资源code
	ResourceCode NullableInt64 `json:"ResourceCode,omitempty"`
	// 资源ID
	ResourceId NullableInt64 `json:"ResourceId,omitempty"`
	// 资源名称
	ResourceName NullableString `json:"ResourceName,omitempty"`
	// 资源状态
	ResourceStatus NullableString `json:"ResourceStatus,omitempty"`
	// 资源类型
...
func NewResourceReference() *ResourceReference {
	...
	this.ResourceName = *NewNullableString(&resourceName)
	var resourceStatus string = ""
	this.ResourceStatus = *NewNullableString(&resourceStatus)
	var resourceType string = ""
	this.ResourceType = *NewNullableString(&resourceType)
	return &this
}
...
func (o *ResourceReference) GetResourceCode() int64 {
	if o == nil || IsNil(o.ResourceCode.Get()) {
		var ret int64
		return ret
	}
...
// SetResourceCode gets a reference to the given NullableInt64 and assigns it to the ResourceCode field.
...
func (o *ResourceReference) GetResourceStatus() string {
	if o == nil || IsNil(o.ResourceStatus.Get()) {
		var ret string
		return ret
	}
...
// SetResourceStatus gets a reference to the given NullableString and assigns it to the ResourceStatus field.
