...
// checks if the TeamAdminMemberData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamAdminMemberData{}

// TeamAdminMemberData 团队管理员分页数据
type TeamAdminMemberData struct {
	// 团队管理员列表信息
	Members []TeamAdminMember `json:"Members,omitempty"`
	// 第几页
...
// SetMembers gets a reference to the given []TeamAdminMember and assigns it to the Members field.
...
func (o TeamAdminMemberData) MarshalJSON() ([]byte, error) {
...
func (o TeamAdminMemberData) ToMap() (map[string]interface{}, error) {
...
type NullableTeamAdminMemberData struct {
	value *TeamAdminMemberData
	isSet bool
}

func (v NullableTeamAdminMemberData) Get() *TeamAdminMemberData {
	return v.value
}

func (v *NullableTeamAdminMemberData) Set(val *TeamAdminMemberData) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamAdminMemberData) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamAdminMemberData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamAdminMemberData(val *TeamAdminMemberData) *NullableTeamAdminMemberData {
	return &NullableTeamAdminMemberData{value: val, isSet: true}
}

func (v NullableTeamAdminMemberData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamAdminMemberData) UnmarshalJSON(src []byte) error {
	v.isSet = true
