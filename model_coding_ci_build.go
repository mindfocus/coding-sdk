...
var _ MappedNullable = &CodingCIBuild{}
...
type CodingCIBuild struct {
	...
	NodeObtainedAt NullableInt64 `json:"NodeObtainedAt,omitempty"`
	// 构建序号
...
func (o *CodingCIBuild) GetNodeObtainedAt() int64 {
	if o == nil || IsNil(o.NodeObtainedAt.Get()) {
		var ret int64
		return ret
	}
...
// SetNodeObtainedAt gets a reference to the given NullableInt64 and assigns it to the NodeObtainedAt field.
