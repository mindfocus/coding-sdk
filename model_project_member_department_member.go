...
var _ MappedNullable = &ProjectMemberDepartmentMember{}

// ProjectMemberDepartmentMember struct for ProjectMemberDepartmentMember
type ProjectMemberDepartmentMember struct {
	// 部门成员refId
	RefId NullableInt64 `json:"RefId"`
	// 关联信息
	Refs []ProjectMemberMemberRef `json:"Refs"`
	// 三方头像
	ThirdPartyAvatar NullableString `json:"ThirdPartyAvatar"`
	// 三方名
	ThirdPartyName NullableString `json:"ThirdPartyName"`
...
func NewProjectMemberDepartmentMemberWithDefaults() *ProjectMemberDepartmentMember {
	...
	this.ThirdPartyAvatar = *NewNullableString(&thirdPartyAvatar)
	var thirdPartyName string = ""
	this.ThirdPartyName = *NewNullableString(&thirdPartyName)
	var thirdPartyId string = ""
	this.ThirdPartyId = &thirdPartyId
	return &this
}
