...
var _ MappedNullable = &AttachmentPrepare{}
...
type AttachmentPrepare struct {
	...
	// 附件上传地址
	PrepareSignUrl NullableString `json:"PrepareSignUrl,omitempty"`
}
...
func NewAttachmentPrepare() *AttachmentPrepare {
	...
	this.PrepareSignUrl = *NewNullableString(&prepareSignUrl)
	return &this
}
...
func (o *AttachmentPrepare) GetPrepareSignUrl() string {
	if o == nil || IsNil(o.PrepareSignUrl.Get()) {
		var ret string
		return ret
	}
...
// SetPrepareSignUrl gets a reference to the given NullableString and assigns it to the PrepareSignUrl field.
