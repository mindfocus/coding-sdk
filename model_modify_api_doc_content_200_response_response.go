...
// checks if the ModifyAPIDocContent200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyAPIDocContent200ResponseResponse{}

// ModifyAPIDocContent200ResponseResponse 公共返回体
type ModifyAPIDocContent200ResponseResponse struct {
...
func NewModifyAPIDocContent200ResponseResponse() *ModifyAPIDocContent200ResponseResponse {
	this := ModifyAPIDocContent200ResponseResponse{}
...
func (o ModifyAPIDocContent200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o ModifyAPIDocContent200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModifyAPIDocContent200ResponseResponse struct {
	value *ModifyAPIDocContent200ResponseResponse
	isSet bool
}

func (v NullableModifyAPIDocContent200ResponseResponse) Get() *ModifyAPIDocContent200ResponseResponse {
	return v.value
}

func (v *NullableModifyAPIDocContent200ResponseResponse) Set(val *ModifyAPIDocContent200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyAPIDocContent200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyAPIDocContent200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyAPIDocContent200ResponseResponse(val *ModifyAPIDocContent200ResponseResponse) *NullableModifyAPIDocContent200ResponseResponse {
	return &NullableModifyAPIDocContent200ResponseResponse{value: val, isSet: true}
}

func (v NullableModifyAPIDocContent200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyAPIDocContent200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
