...
// checks if the DescribeEvents200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeEvents200ResponseResponse{}

// DescribeEvents200ResponseResponse 公共返回体
type DescribeEvents200ResponseResponse struct {
	// 事件列表
	Event []ServiceHookEvent `json:"Event,omitempty"`
	// 请求id
...
func NewDescribeEvents200ResponseResponse() *DescribeEvents200ResponseResponse {
	this := DescribeEvents200ResponseResponse{}
...
// SetEvent gets a reference to the given []ServiceHookEvent and assigns it to the Event field.
...
func (o DescribeEvents200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeEvents200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeEvents200ResponseResponse struct {
	value *DescribeEvents200ResponseResponse
	isSet bool
}

func (v NullableDescribeEvents200ResponseResponse) Get() *DescribeEvents200ResponseResponse {
	return v.value
}

func (v *NullableDescribeEvents200ResponseResponse) Set(val *DescribeEvents200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeEvents200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeEvents200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeEvents200ResponseResponse(val *DescribeEvents200ResponseResponse) *NullableDescribeEvents200ResponseResponse {
	return &NullableDescribeEvents200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeEvents200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeEvents200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
