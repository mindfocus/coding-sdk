...
// checks if the ModifyDepotPushSetting200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyDepotPushSetting200ResponseResponse{}

// ModifyDepotPushSetting200ResponseResponse 公共返回体
type ModifyDepotPushSetting200ResponseResponse struct {
	Data *DepotPushSetting `json:"Data,omitempty"`
	// 请求id
	RequestId *string `json:"RequestId,omitempty"`
}

// NewModifyDepotPushSetting200ResponseResponse instantiates a new ModifyDepotPushSetting200ResponseResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewModifyDepotPushSetting200ResponseResponse() *ModifyDepotPushSetting200ResponseResponse {
	this := ModifyDepotPushSetting200ResponseResponse{}
	var requestId string = "xxxxx"
	this.RequestId = &requestId
	return &this
}

// NewModifyDepotPushSetting200ResponseResponseWithDefaults instantiates a new ModifyDepotPushSetting200ResponseResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewModifyDepotPushSetting200ResponseResponseWithDefaults() *ModifyDepotPushSetting200ResponseResponse {
	this := ModifyDepotPushSetting200ResponseResponse{}
	var requestId string = "xxxxx"
	this.RequestId = &requestId
	return &this
...
func (o *ModifyDepotPushSetting200ResponseResponse) GetData() DepotPushSetting {
...
func (o *ModifyDepotPushSetting200ResponseResponse) GetDataOk() (*DepotPushSetting, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *ModifyDepotPushSetting200ResponseResponse) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given DepotPushSetting and assigns it to the Data field.
func (o *ModifyDepotPushSetting200ResponseResponse) SetData(v DepotPushSetting) {
	o.Data = &v
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *ModifyDepotPushSetting200ResponseResponse) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *ModifyDepotPushSetting200ResponseResponse) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *ModifyDepotPushSetting200ResponseResponse) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *ModifyDepotPushSetting200ResponseResponse) SetRequestId(v string) {
	o.RequestId = &v
}

func (o ModifyDepotPushSetting200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o ModifyDepotPushSetting200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModifyDepotPushSetting200ResponseResponse struct {
	value *ModifyDepotPushSetting200ResponseResponse
	isSet bool
}

func (v NullableModifyDepotPushSetting200ResponseResponse) Get() *ModifyDepotPushSetting200ResponseResponse {
	return v.value
}

func (v *NullableModifyDepotPushSetting200ResponseResponse) Set(val *ModifyDepotPushSetting200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyDepotPushSetting200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyDepotPushSetting200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyDepotPushSetting200ResponseResponse(val *ModifyDepotPushSetting200ResponseResponse) *NullableModifyDepotPushSetting200ResponseResponse {
	return &NullableModifyDepotPushSetting200ResponseResponse{value: val, isSet: true}
}

func (v NullableModifyDepotPushSetting200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyDepotPushSetting200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
