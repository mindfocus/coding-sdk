...
var _ MappedNullable = &CustomFieldChangeLog{}
...
type CustomFieldChangeLog struct {
	...
	// 创建人ID 
	Creator NullableInt64 `json:"Creator,omitempty"`
	// 自定义属性ID 
	FieldId NullableInt64 `json:"FieldId,omitempty"`
	// 自定义属性名字 
	FieldName NullableString `json:"FieldName,omitempty"`
	// 自定义属性类型 
	FieldType NullableString `json:"FieldType,omitempty"`
	// 自定义属性的值 
	FieldValue NullableString `json:"FieldValue,omitempty"`
	// 事项id（不是页面上的ID，是数据库中的唯一ID）
	IssueId NullableInt64 `json:"IssueId,omitempty"`
	// 更新时间戳 
...
func NewCustomFieldChangeLog() *CustomFieldChangeLog {
	...
	this.ActionType = *NewNullableString(&actionType)
	var fieldName string = ""
	this.FieldName = *NewNullableString(&fieldName)
	var fieldType string = ""
	this.FieldType = *NewNullableString(&fieldType)
	var fieldValue string = ""
	this.FieldValue = *NewNullableString(&fieldValue)
	return &this
}
...
// SetCreator gets a reference to the given NullableInt64 and assigns it to the Creator field.
...
// SetFieldId gets a reference to the given NullableInt64 and assigns it to the FieldId field.
...
func (o *CustomFieldChangeLog) GetFieldValue() string {
	if o == nil || IsNil(o.FieldValue.Get()) {
		var ret string
		return ret
	}
...
// SetFieldValue gets a reference to the given NullableString and assigns it to the FieldValue field.
...
// SetIssueId gets a reference to the given NullableInt64 and assigns it to the IssueId field.
