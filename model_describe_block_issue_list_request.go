...
// checks if the DescribeBlockIssueListRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeBlockIssueListRequest{}

// DescribeBlockIssueListRequest struct for DescribeBlockIssueListRequest
type DescribeBlockIssueListRequest struct {
	// 事项 Code
...
type _DescribeBlockIssueListRequest DescribeBlockIssueListRequest
...
func NewDescribeBlockIssueListRequest(issueCode int64, projectName string) *DescribeBlockIssueListRequest {
	this := DescribeBlockIssueListRequest{}
...
func (o DescribeBlockIssueListRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeBlockIssueListRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeBlockIssueListRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeBlockIssueListRequest := _DescribeBlockIssueListRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeBlockIssueListRequest)

	if err != nil {
		return err
	}

	*o = DescribeBlockIssueListRequest(varDescribeBlockIssueListRequest)

	return err
}

type NullableDescribeBlockIssueListRequest struct {
	value *DescribeBlockIssueListRequest
	isSet bool
}

func (v NullableDescribeBlockIssueListRequest) Get() *DescribeBlockIssueListRequest {
	return v.value
}

func (v *NullableDescribeBlockIssueListRequest) Set(val *DescribeBlockIssueListRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeBlockIssueListRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeBlockIssueListRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeBlockIssueListRequest(val *DescribeBlockIssueListRequest) *NullableDescribeBlockIssueListRequest {
	return &NullableDescribeBlockIssueListRequest{value: val, isSet: true}
}

func (v NullableDescribeBlockIssueListRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeBlockIssueListRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
