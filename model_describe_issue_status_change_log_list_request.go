...
// checks if the DescribeIssueStatusChangeLogListRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeIssueStatusChangeLogListRequest{}

// DescribeIssueStatusChangeLogListRequest struct for DescribeIssueStatusChangeLogListRequest
type DescribeIssueStatusChangeLogListRequest struct {
	// 事项code列表
...
type _DescribeIssueStatusChangeLogListRequest DescribeIssueStatusChangeLogListRequest
...
func NewDescribeIssueStatusChangeLogListRequest(issueCode []int64, projectName string) *DescribeIssueStatusChangeLogListRequest {
	this := DescribeIssueStatusChangeLogListRequest{}
...
func (o DescribeIssueStatusChangeLogListRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeIssueStatusChangeLogListRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeIssueStatusChangeLogListRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeIssueStatusChangeLogListRequest := _DescribeIssueStatusChangeLogListRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeIssueStatusChangeLogListRequest)

	if err != nil {
		return err
	}

	*o = DescribeIssueStatusChangeLogListRequest(varDescribeIssueStatusChangeLogListRequest)

	return err
}

type NullableDescribeIssueStatusChangeLogListRequest struct {
	value *DescribeIssueStatusChangeLogListRequest
	isSet bool
}

func (v NullableDescribeIssueStatusChangeLogListRequest) Get() *DescribeIssueStatusChangeLogListRequest {
	return v.value
}

func (v *NullableDescribeIssueStatusChangeLogListRequest) Set(val *DescribeIssueStatusChangeLogListRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeIssueStatusChangeLogListRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeIssueStatusChangeLogListRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeIssueStatusChangeLogListRequest(val *DescribeIssueStatusChangeLogListRequest) *NullableDescribeIssueStatusChangeLogListRequest {
	return &NullableDescribeIssueStatusChangeLogListRequest{value: val, isSet: true}
}

func (v NullableDescribeIssueStatusChangeLogListRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeIssueStatusChangeLogListRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
