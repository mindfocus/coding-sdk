...
type Test struct {
	...
	// 用例 ID
	CaseId NullableInt32 `json:"CaseId,omitempty"`
	// 测试任务 ID
	...
	// 测试时间
	TestedAt NullableString `json:"TestedAt,omitempty"`
	// 标题
...
func NewTest() *Test {
	...
	var testedAt string = ""
	this.TestedAt = *NewNullableString(&testedAt)
	var title string = ""
...
// SetCaseId gets a reference to the given NullableInt32 and assigns it to the CaseId field.
...
// SetTestedAt gets a reference to the given NullableString and assigns it to the TestedAt field.
