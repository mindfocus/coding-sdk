...
// checks if the DescribeGitReleases200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitReleases200ResponseResponse{}

// DescribeGitReleases200ResponseResponse 公共返回体
type DescribeGitReleases200ResponseResponse struct {
	ReleasePageList *ReleaseListPage `json:"ReleasePageList,omitempty"`
	// 请求id
...
func NewDescribeGitReleases200ResponseResponse() *DescribeGitReleases200ResponseResponse {
	this := DescribeGitReleases200ResponseResponse{}
...
// GetReleasePageList returns the ReleasePageList field value if set, zero value otherwise.
func (o *DescribeGitReleases200ResponseResponse) GetReleasePageList() ReleaseListPage {
	if o == nil || IsNil(o.ReleasePageList) {
		var ret ReleaseListPage
		return ret
	}
	return *o.ReleasePageList
}

// GetReleasePageListOk returns a tuple with the ReleasePageList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DescribeGitReleases200ResponseResponse) GetReleasePageListOk() (*ReleaseListPage, bool) {
	if o == nil || IsNil(o.ReleasePageList) {
		return nil, false
	}
	return o.ReleasePageList, true
}
...
// SetReleasePageList gets a reference to the given ReleaseListPage and assigns it to the ReleasePageList field.
...
func (o DescribeGitReleases200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitReleases200ResponseResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReleasePageList) {
		toSerialize["ReleasePageList"] = o.ReleasePageList
	}
...
type NullableDescribeGitReleases200ResponseResponse struct {
	value *DescribeGitReleases200ResponseResponse
	isSet bool
}

func (v NullableDescribeGitReleases200ResponseResponse) Get() *DescribeGitReleases200ResponseResponse {
	return v.value
}

func (v *NullableDescribeGitReleases200ResponseResponse) Set(val *DescribeGitReleases200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitReleases200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitReleases200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitReleases200ResponseResponse(val *DescribeGitReleases200ResponseResponse) *NullableDescribeGitReleases200ResponseResponse {
	return &NullableDescribeGitReleases200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeGitReleases200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitReleases200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
