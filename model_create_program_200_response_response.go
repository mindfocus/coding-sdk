...
// checks if the CreateProgram200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateProgram200ResponseResponse{}

// CreateProgram200ResponseResponse 公共返回体
type CreateProgram200ResponseResponse struct {
...
func NewCreateProgram200ResponseResponse() *CreateProgram200ResponseResponse {
	this := CreateProgram200ResponseResponse{}
...
func (o CreateProgram200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateProgram200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateProgram200ResponseResponse struct {
	value *CreateProgram200ResponseResponse
	isSet bool
}

func (v NullableCreateProgram200ResponseResponse) Get() *CreateProgram200ResponseResponse {
	return v.value
}

func (v *NullableCreateProgram200ResponseResponse) Set(val *CreateProgram200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateProgram200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateProgram200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateProgram200ResponseResponse(val *CreateProgram200ResponseResponse) *NullableCreateProgram200ResponseResponse {
	return &NullableCreateProgram200ResponseResponse{value: val, isSet: true}
}

func (v NullableCreateProgram200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateProgram200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
