...
var _ MappedNullable = &ProjectIssueField{}
...
type ProjectIssueField struct {
	...
	ValueString NullableString `json:"ValueString,omitempty"`
}
...
func NewProjectIssueField() *ProjectIssueField {
	...
	this.ValueString = *NewNullableString(&valueString)
	return &this
}
...
func (o *ProjectIssueField) GetValueString() string {
	if o == nil || IsNil(o.ValueString.Get()) {
		var ret string
		return ret
	}
...
// SetValueString gets a reference to the given NullableString and assigns it to the ValueString field.
