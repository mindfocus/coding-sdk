...
// checks if the DescribeCdDeployTimeByProjectRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCdDeployTimeByProjectRequest{}

// DescribeCdDeployTimeByProjectRequest struct for DescribeCdDeployTimeByProjectRequest
type DescribeCdDeployTimeByProjectRequest struct {
...
type _DescribeCdDeployTimeByProjectRequest DescribeCdDeployTimeByProjectRequest
...
func NewDescribeCdDeployTimeByProjectRequest(endAt string, projectName string, startAt string) *DescribeCdDeployTimeByProjectRequest {
	this := DescribeCdDeployTimeByProjectRequest{}
	this.EndAt = endAt
...
func (o DescribeCdDeployTimeByProjectRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeCdDeployTimeByProjectRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeCdDeployTimeByProjectRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeCdDeployTimeByProjectRequest := _DescribeCdDeployTimeByProjectRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeCdDeployTimeByProjectRequest)

	if err != nil {
		return err
	}

	*o = DescribeCdDeployTimeByProjectRequest(varDescribeCdDeployTimeByProjectRequest)

	return err
}

type NullableDescribeCdDeployTimeByProjectRequest struct {
	value *DescribeCdDeployTimeByProjectRequest
	isSet bool
}

func (v NullableDescribeCdDeployTimeByProjectRequest) Get() *DescribeCdDeployTimeByProjectRequest {
	return v.value
}

func (v *NullableDescribeCdDeployTimeByProjectRequest) Set(val *DescribeCdDeployTimeByProjectRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCdDeployTimeByProjectRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCdDeployTimeByProjectRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCdDeployTimeByProjectRequest(val *DescribeCdDeployTimeByProjectRequest) *NullableDescribeCdDeployTimeByProjectRequest {
	return &NullableDescribeCdDeployTimeByProjectRequest{value: val, isSet: true}
}

func (v NullableDescribeCdDeployTimeByProjectRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCdDeployTimeByProjectRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
