...
// checks if the DeleteBranchProtectionMemberRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteBranchProtectionMemberRequest{}

// DeleteBranchProtectionMemberRequest struct for DeleteBranchProtectionMemberRequest
type DeleteBranchProtectionMemberRequest struct {
	// 保护分支规则id
...
type _DeleteBranchProtectionMemberRequest DeleteBranchProtectionMemberRequest
...
func NewDeleteBranchProtectionMemberRequest(branchProtectionId int64, depotId int64, userGlobalKey string) *DeleteBranchProtectionMemberRequest {
	this := DeleteBranchProtectionMemberRequest{}
...
func (o DeleteBranchProtectionMemberRequest) MarshalJSON() ([]byte, error) {
...
func (o DeleteBranchProtectionMemberRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteBranchProtectionMemberRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteBranchProtectionMemberRequest := _DeleteBranchProtectionMemberRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteBranchProtectionMemberRequest)

	if err != nil {
		return err
	}

	*o = DeleteBranchProtectionMemberRequest(varDeleteBranchProtectionMemberRequest)

	return err
}

type NullableDeleteBranchProtectionMemberRequest struct {
	value *DeleteBranchProtectionMemberRequest
	isSet bool
}

func (v NullableDeleteBranchProtectionMemberRequest) Get() *DeleteBranchProtectionMemberRequest {
	return v.value
}

func (v *NullableDeleteBranchProtectionMemberRequest) Set(val *DeleteBranchProtectionMemberRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteBranchProtectionMemberRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteBranchProtectionMemberRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteBranchProtectionMemberRequest(val *DeleteBranchProtectionMemberRequest) *NullableDeleteBranchProtectionMemberRequest {
	return &NullableDeleteBranchProtectionMemberRequest{value: val, isSet: true}
}

func (v NullableDeleteBranchProtectionMemberRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteBranchProtectionMemberRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
