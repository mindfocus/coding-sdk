...
type Line struct {
	// diff信息中的行数
	Index NullableInt64 `json:"Index,omitempty"`
	// 修改前第几行
	LeftNo NullableInt64 `json:"LeftNo,omitempty"`
	// 前缀 + -
	Prefix NullableString `json:"Prefix,omitempty"`
	// 修改后第几行
	RightNo NullableInt64 `json:"RightNo,omitempty"`
	// 文件每行的具体内容
...
func NewLine() *Line {
	this := Line{}
	var prefix string = ""
	this.Prefix = *NewNullableString(&prefix)
	var text string = ""
...
// SetIndex gets a reference to the given NullableInt64 and assigns it to the Index field.
...
// SetLeftNo gets a reference to the given NullableInt64 and assigns it to the LeftNo field.
...
// SetRightNo gets a reference to the given NullableInt64 and assigns it to the RightNo field.
