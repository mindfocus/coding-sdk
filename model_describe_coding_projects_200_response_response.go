...
// checks if the DescribeCodingProjects200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeCodingProjects200ResponseResponse{}

// DescribeCodingProjects200ResponseResponse 公共返回体
type DescribeCodingProjects200ResponseResponse struct {
...
func NewDescribeCodingProjects200ResponseResponse() *DescribeCodingProjects200ResponseResponse {
	this := DescribeCodingProjects200ResponseResponse{}
...
func (o DescribeCodingProjects200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeCodingProjects200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeCodingProjects200ResponseResponse struct {
	value *DescribeCodingProjects200ResponseResponse
	isSet bool
}

func (v NullableDescribeCodingProjects200ResponseResponse) Get() *DescribeCodingProjects200ResponseResponse {
	return v.value
}

func (v *NullableDescribeCodingProjects200ResponseResponse) Set(val *DescribeCodingProjects200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeCodingProjects200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeCodingProjects200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeCodingProjects200ResponseResponse(val *DescribeCodingProjects200ResponseResponse) *NullableDescribeCodingProjects200ResponseResponse {
	return &NullableDescribeCodingProjects200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeCodingProjects200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeCodingProjects200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
