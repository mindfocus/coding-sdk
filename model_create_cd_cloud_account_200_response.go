...
// checks if the CreateCdCloudAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCdCloudAccount200Response{}

// CreateCdCloudAccount200Response struct for CreateCdCloudAccount200Response
type CreateCdCloudAccount200Response struct {
	Response *CreateCdCloudAccount200ResponseResponse `json:"Response,omitempty"`
}
...
func NewCreateCdCloudAccount200Response() *CreateCdCloudAccount200Response {
	this := CreateCdCloudAccount200Response{}
	return &this
}
...
func (o *CreateCdCloudAccount200Response) GetResponse() CreateCdCloudAccount200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret CreateCdCloudAccount200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given CreateCdCloudAccount200ResponseResponse and assigns it to the Response field.
func (o *CreateCdCloudAccount200Response) SetResponse(v CreateCdCloudAccount200ResponseResponse) {
	o.Response = &v
}

func (o CreateCdCloudAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o CreateCdCloudAccount200Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCdCloudAccount200Response struct {
	value *CreateCdCloudAccount200Response
	isSet bool
}

func (v NullableCreateCdCloudAccount200Response) Get() *CreateCdCloudAccount200Response {
	return v.value
}

func (v *NullableCreateCdCloudAccount200Response) Set(val *CreateCdCloudAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCdCloudAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCdCloudAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCdCloudAccount200Response(val *CreateCdCloudAccount200Response) *NullableCreateCdCloudAccount200Response {
	return &NullableCreateCdCloudAccount200Response{value: val, isSet: true}
}

func (v NullableCreateCdCloudAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCdCloudAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
