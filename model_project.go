...
type Project struct {
	...
	// 创建时间
	CreatedAt NullableInt32 `json:"CreatedAt,omitempty"`
	// 描述
	Description NullableString `json:"Description,omitempty"`
	// 显示名称
	DisplayName NullableString `json:"DisplayName,omitempty"`
	// 项目结束时间
	EndDate NullableInt32 `json:"EndDate,omitempty"`
	// 图标
	...
	// 最大团员数
	MaxMember NullableInt32 `json:"MaxMember,omitempty"`
	// 名称
	...
	// 团队所有者 ID
	TeamOwnerId NullableInt32 `json:"TeamOwnerId,omitempty"`
	// 项目类型, 项目集为0，公开项目为1，私密项目为2
	Type NullableInt32 `json:"Type,omitempty"`
	// 更新时间
	UpdatedAt NullableInt32 `json:"UpdatedAt,omitempty"`
	// 个人所有者 ID
	UserOwnerId NullableInt32 `json:"UserOwnerId,omitempty"`
	// 项目集id
...
func NewProject() *Project {
	...
	this.Archived = *NewNullableBool(&archived)
	var description string = ""
	this.Description = *NewNullableString(&description)
	var displayName string = ""
	this.DisplayName = *NewNullableString(&displayName)
	var icon string = ""
	this.Icon = *NewNullableString(&icon)
	var isDemo bool = false
	this.IsDemo = *NewNullableBool(&isDemo)
	var name string = ""
...
func (o *Project) GetMaxMember() int32 {
	if o == nil || IsNil(o.MaxMember.Get()) {
		var ret int32
		return ret
	}
...
// SetMaxMember gets a reference to the given NullableInt32 and assigns it to the MaxMember field.
...
func (o *Project) GetTeamOwnerId() int32 {
	if o == nil || IsNil(o.TeamOwnerId.Get()) {
		var ret int32
		return ret
	}
...
// SetTeamOwnerId gets a reference to the given NullableInt32 and assigns it to the TeamOwnerId field.
...
func (o *Project) GetUserOwnerId() int32 {
	if o == nil || IsNil(o.UserOwnerId.Get()) {
		var ret int32
		return ret
	}
...
// SetUserOwnerId gets a reference to the given NullableInt32 and assigns it to the UserOwnerId field.
