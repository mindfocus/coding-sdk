...
// checks if the DescribeGitMergeRequestDiffDetailRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitMergeRequestDiffDetailRequest{}

// DescribeGitMergeRequestDiffDetailRequest struct for DescribeGitMergeRequestDiffDetailRequest
type DescribeGitMergeRequestDiffDetailRequest struct {
	// 仓库id
...
type _DescribeGitMergeRequestDiffDetailRequest DescribeGitMergeRequestDiffDetailRequest
...
func NewDescribeGitMergeRequestDiffDetailRequest(depotId int64, mergeId int64, path string) *DescribeGitMergeRequestDiffDetailRequest {
	this := DescribeGitMergeRequestDiffDetailRequest{}
...
func (o DescribeGitMergeRequestDiffDetailRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitMergeRequestDiffDetailRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeGitMergeRequestDiffDetailRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeGitMergeRequestDiffDetailRequest := _DescribeGitMergeRequestDiffDetailRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeGitMergeRequestDiffDetailRequest)

	if err != nil {
		return err
	}

	*o = DescribeGitMergeRequestDiffDetailRequest(varDescribeGitMergeRequestDiffDetailRequest)

	return err
}

type NullableDescribeGitMergeRequestDiffDetailRequest struct {
	value *DescribeGitMergeRequestDiffDetailRequest
	isSet bool
}

func (v NullableDescribeGitMergeRequestDiffDetailRequest) Get() *DescribeGitMergeRequestDiffDetailRequest {
	return v.value
}

func (v *NullableDescribeGitMergeRequestDiffDetailRequest) Set(val *DescribeGitMergeRequestDiffDetailRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitMergeRequestDiffDetailRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitMergeRequestDiffDetailRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitMergeRequestDiffDetailRequest(val *DescribeGitMergeRequestDiffDetailRequest) *NullableDescribeGitMergeRequestDiffDetailRequest {
	return &NullableDescribeGitMergeRequestDiffDetailRequest{value: val, isSet: true}
}

func (v NullableDescribeGitMergeRequestDiffDetailRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitMergeRequestDiffDetailRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
