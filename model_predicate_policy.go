...
var _ MappedNullable = &PredicatePolicy{}
...
func (o *PredicatePolicy) GetHasAdministrator() bool {
	if o == nil || IsNil(o.HasAdministrator) {
		var ret bool
		return ret
	}
...
func (o *PredicatePolicy) GetResourcePredicatePolicy() string {
	if o == nil || IsNil(o.ResourcePredicatePolicy) {
		var ret string
		return ret
	}
...
func (o PredicatePolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HasAdministrator) {
		toSerialize["HasAdministrator"] = o.HasAdministrator
	}
	if !IsNil(o.ResourcePredicatePolicy) {
