...
// checks if the ArtifactRepositoryPageBean type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactRepositoryPageBean{}

// ArtifactRepositoryPageBean 制品仓库列表分页返回体
type ArtifactRepositoryPageBean struct {
	// 分页数据列表
	InstanceSet []ArtifactRepositoryBean `json:"InstanceSet,omitempty"`
	// 页码
...
func NewArtifactRepositoryPageBean() *ArtifactRepositoryPageBean {
	this := ArtifactRepositoryPageBean{}
	return &this
}
...
func (o *ArtifactRepositoryPageBean) GetInstanceSet() []ArtifactRepositoryBean {
	if o == nil || IsNil(o.InstanceSet) {
		var ret []ArtifactRepositoryBean
		return ret
	}
...
// SetInstanceSet gets a reference to the given []ArtifactRepositoryBean and assigns it to the InstanceSet field.
...
func (o ArtifactRepositoryPageBean) MarshalJSON() ([]byte, error) {
...
func (o ArtifactRepositoryPageBean) ToMap() (map[string]interface{}, error) {
...
type NullableArtifactRepositoryPageBean struct {
	value *ArtifactRepositoryPageBean
	isSet bool
}

func (v NullableArtifactRepositoryPageBean) Get() *ArtifactRepositoryPageBean {
	return v.value
}

func (v *NullableArtifactRepositoryPageBean) Set(val *ArtifactRepositoryPageBean) {
	v.value = val
	v.isSet = true
}

func (v NullableArtifactRepositoryPageBean) IsSet() bool {
	return v.isSet
}

func (v *NullableArtifactRepositoryPageBean) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArtifactRepositoryPageBean(val *ArtifactRepositoryPageBean) *NullableArtifactRepositoryPageBean {
	return &NullableArtifactRepositoryPageBean{value: val, isSet: true}
}

func (v NullableArtifactRepositoryPageBean) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArtifactRepositoryPageBean) UnmarshalJSON(src []byte) error {
	v.isSet = true
