...
// checks if the DescribeGitReleaseDetailRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeGitReleaseDetailRequest{}

// DescribeGitReleaseDetailRequest struct for DescribeGitReleaseDetailRequest
type DescribeGitReleaseDetailRequest struct {
	// 仓库id
...
type _DescribeGitReleaseDetailRequest DescribeGitReleaseDetailRequest
...
func NewDescribeGitReleaseDetailRequest(depotId int64, releaseId int64, tagName string) *DescribeGitReleaseDetailRequest {
	this := DescribeGitReleaseDetailRequest{}
...
func (o DescribeGitReleaseDetailRequest) MarshalJSON() ([]byte, error) {
...
func (o DescribeGitReleaseDetailRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DescribeGitReleaseDetailRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDescribeGitReleaseDetailRequest := _DescribeGitReleaseDetailRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDescribeGitReleaseDetailRequest)

	if err != nil {
		return err
	}

	*o = DescribeGitReleaseDetailRequest(varDescribeGitReleaseDetailRequest)

	return err
}

type NullableDescribeGitReleaseDetailRequest struct {
	value *DescribeGitReleaseDetailRequest
	isSet bool
}

func (v NullableDescribeGitReleaseDetailRequest) Get() *DescribeGitReleaseDetailRequest {
	return v.value
}

func (v *NullableDescribeGitReleaseDetailRequest) Set(val *DescribeGitReleaseDetailRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeGitReleaseDetailRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeGitReleaseDetailRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeGitReleaseDetailRequest(val *DescribeGitReleaseDetailRequest) *NullableDescribeGitReleaseDetailRequest {
	return &NullableDescribeGitReleaseDetailRequest{value: val, isSet: true}
}

func (v NullableDescribeGitReleaseDetailRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeGitReleaseDetailRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
