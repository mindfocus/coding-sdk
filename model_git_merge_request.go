...
var _ MappedNullable = &GitMergeRequest{}
...
type GitMergeRequest struct {
	...
	// 仓库路径
	DepotPath NullableString `json:"DepotPath,omitempty"`
	// 定位一个项目的内的资源的 ID
...
func NewGitMergeRequest() *GitMergeRequest {
	...
	this.DepotPath = *NewNullableString(&depotPath)
	return &this
}
...
func (o *GitMergeRequest) GetDepotPath() string {
	if o == nil || IsNil(o.DepotPath.Get()) {
		var ret string
		return ret
	}
...
// SetDepotPath gets a reference to the given NullableString and assigns it to the DepotPath field.
