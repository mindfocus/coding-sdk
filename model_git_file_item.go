...
var _ MappedNullable = &GitFileItem{}
...
type GitFileItem struct {
	...
	// 文件内容的hash结果
	ContentSha256 NullableString `json:"ContentSha256,omitempty"`
	// 加密形式
...
func NewGitFileItem() *GitFileItem {
	...
	this.ContentSha256 = *NewNullableString(&contentSha256)
	var encoding string = ""
...
func (o *GitFileItem) GetContentSha256() string {
	if o == nil || IsNil(o.ContentSha256.Get()) {
		var ret string
		return ret
	}
...
// SetContentSha256 gets a reference to the given NullableString and assigns it to the ContentSha256 field.
