...
type TestFull struct {
	...
	// 测试人 ID
	TestedBy NullableInt32 `json:"TestedBy,omitempty"`
	// 标题
...
// SetTestedBy gets a reference to the given NullableInt32 and assigns it to the TestedBy field.
