...
// checks if the DescribeTestDefectList200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeTestDefectList200ResponseResponse{}

// DescribeTestDefectList200ResponseResponse 公共返回体
type DescribeTestDefectList200ResponseResponse struct {
	Data *TestDefectsData `json:"Data,omitempty"`
	// 请求id
...
func NewDescribeTestDefectList200ResponseResponse() *DescribeTestDefectList200ResponseResponse {
	this := DescribeTestDefectList200ResponseResponse{}
...
// SetData gets a reference to the given TestDefectsData and assigns it to the Data field.
...
func (o DescribeTestDefectList200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o DescribeTestDefectList200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeTestDefectList200ResponseResponse struct {
	value *DescribeTestDefectList200ResponseResponse
	isSet bool
}

func (v NullableDescribeTestDefectList200ResponseResponse) Get() *DescribeTestDefectList200ResponseResponse {
	return v.value
}

func (v *NullableDescribeTestDefectList200ResponseResponse) Set(val *DescribeTestDefectList200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeTestDefectList200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeTestDefectList200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeTestDefectList200ResponseResponse(val *DescribeTestDefectList200ResponseResponse) *NullableDescribeTestDefectList200ResponseResponse {
	return &NullableDescribeTestDefectList200ResponseResponse{value: val, isSet: true}
}

func (v NullableDescribeTestDefectList200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeTestDefectList200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
