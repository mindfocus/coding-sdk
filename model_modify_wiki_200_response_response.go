...
// checks if the ModifyWiki200ResponseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModifyWiki200ResponseResponse{}

// ModifyWiki200ResponseResponse 公共返回体
type ModifyWiki200ResponseResponse struct {
	Data *WikiData `json:"Data,omitempty"`
	// 请求id
...
func NewModifyWiki200ResponseResponse() *ModifyWiki200ResponseResponse {
	this := ModifyWiki200ResponseResponse{}
...
// SetData gets a reference to the given WikiData and assigns it to the Data field.
...
func (o ModifyWiki200ResponseResponse) MarshalJSON() ([]byte, error) {
...
func (o ModifyWiki200ResponseResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModifyWiki200ResponseResponse struct {
	value *ModifyWiki200ResponseResponse
	isSet bool
}

func (v NullableModifyWiki200ResponseResponse) Get() *ModifyWiki200ResponseResponse {
	return v.value
}

func (v *NullableModifyWiki200ResponseResponse) Set(val *ModifyWiki200ResponseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyWiki200ResponseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyWiki200ResponseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyWiki200ResponseResponse(val *ModifyWiki200ResponseResponse) *NullableModifyWiki200ResponseResponse {
	return &NullableModifyWiki200ResponseResponse{value: val, isSet: true}
}

func (v NullableModifyWiki200ResponseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyWiki200ResponseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
