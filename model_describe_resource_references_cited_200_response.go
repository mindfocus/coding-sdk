...
// checks if the DescribeResourceReferencesCited200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DescribeResourceReferencesCited200Response{}

// DescribeResourceReferencesCited200Response struct for DescribeResourceReferencesCited200Response
type DescribeResourceReferencesCited200Response struct {
	Response *DescribeResourceReferencesCited200ResponseResponse `json:"Response,omitempty"`
}
...
func NewDescribeResourceReferencesCited200Response() *DescribeResourceReferencesCited200Response {
	this := DescribeResourceReferencesCited200Response{}
	return &this
}
...
func (o *DescribeResourceReferencesCited200Response) GetResponse() DescribeResourceReferencesCited200ResponseResponse {
	if o == nil || IsNil(o.Response) {
		var ret DescribeResourceReferencesCited200ResponseResponse
		return ret
	}
	return *o.Response
}
...
// SetResponse gets a reference to the given DescribeResourceReferencesCited200ResponseResponse and assigns it to the Response field.
func (o *DescribeResourceReferencesCited200Response) SetResponse(v DescribeResourceReferencesCited200ResponseResponse) {
	o.Response = &v
}

func (o DescribeResourceReferencesCited200Response) MarshalJSON() ([]byte, error) {
...
func (o DescribeResourceReferencesCited200Response) ToMap() (map[string]interface{}, error) {
...
type NullableDescribeResourceReferencesCited200Response struct {
	value *DescribeResourceReferencesCited200Response
	isSet bool
}

func (v NullableDescribeResourceReferencesCited200Response) Get() *DescribeResourceReferencesCited200Response {
	return v.value
}

func (v *NullableDescribeResourceReferencesCited200Response) Set(val *DescribeResourceReferencesCited200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDescribeResourceReferencesCited200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDescribeResourceReferencesCited200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDescribeResourceReferencesCited200Response(val *DescribeResourceReferencesCited200Response) *NullableDescribeResourceReferencesCited200Response {
	return &NullableDescribeResourceReferencesCited200Response{value: val, isSet: true}
}

func (v NullableDescribeResourceReferencesCited200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDescribeResourceReferencesCited200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
